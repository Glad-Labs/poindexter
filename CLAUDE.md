...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-09-22)
...
- 208 live posts on gladlabs.io (382 posts total; 2,127 pipeline_tasks across all generation runs)
- 511 Python files under `src/cofounder_agent/poindexter/services/` (~291 substantive after `__init__.py` stubs)
...
- 80,858 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
