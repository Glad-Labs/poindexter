...
| RSS Feed             | WORKING            | Blog feed.xml + JSON Feed 1.1. Feed dedup via `distributed_at` + cutoff date. Direct Bluesky + Mastodon adapters replaced dlvr.it (GH-36); X/Twitter stays manual per row below. |
