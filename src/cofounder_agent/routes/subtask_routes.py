...
async def run_research_subtask(
    ...
    try:
        ...
        await db_service.add_task(
            {
                ...
                "metadata": {
                    ...
                    "inputs": {"topic": request.topic, "keywords": request.keywords},
                },
            }
        )
        ...
        await db_service.update_task_status(subtask_id, "completed", result_data)
        ...
        try:
            await db_service.update_task_status(subtask_id, "failed", {"error": str(e)})
...
async def run_creative_subtask(
    ...
    try:
        ...
        return SubtaskResponse(
            ...
            status="completed",
            result=result_data,
            metadata={"duration_ms": 25000, "tokens_used": 0, "model": "gpt-4"},
        )
...
async def run_image_subtask(
    ...
    try:
        ...
        return SubtaskResponse(
            ...
            status="completed",
            result=result_data,
            metadata={"duration_ms": 8000, "tokens_used": 0, "model": "vision", "images_found": 1},
        )
...
async def run_format_subtask(
    ...
    try:
        ...
        return SubtaskResponse(
            ...
            status="completed",
            result=result_data,
            metadata={"duration_ms": 3000, "tokens_used": 0, "model": "gpt-3.5"},
        )
