...
- Otherwise, any non-image_gen slot (Pexels stock) fails unless the
...
ATOM_META = AtomMeta(
    ...
    description=(
        ...
        "Pexels stock slots fail unless allow_stock. Raising here halts the "
...
async def run(state: dict[str, Any]) -> dict[str, Any]:
    ...
    stock = [f"inline:{r.get('num')}" for r in image_results if r.get("source") != "image_gen"]
