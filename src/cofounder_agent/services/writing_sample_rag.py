...
class WritingSampleRAGService:
    ...
    async def retrieve_relevant_samples(
        ...
        try:
            ...
            if scored_samples:
                ...
                logger.info(f"✅ RAG: Top sample: {top['sample'].get('title')} "
    ...
    def _calculate_relevance_score(
        ...
        topic_similarity = self._calculate_topic_similarity(
            query_topic, sample_text, sample_title
        )
    ...
    def _calculate_topic_similarity(
        ...
        sample_words = set(re.findall(r'\b\w{4,}\b', 
                                     (sample_title + " " + sample_text).lower()))
