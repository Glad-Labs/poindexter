...
## [0.1.1](https://github.com/Glad-Labs/poindexter/compare/v0.1.0...v0.1.1) (2026-04-12)


### Features

* 15 self-healing tasks in idle worker — detect, fix, learn ([edca901](https://github.com/Glad-Labs/poindexter/commit/edca901e4e94b89a41ee9504e6b0133ec612d76e))
* 3 new enterprise-quality dashboards focused on human oversight workflow ([b15d0d7](https://github.com/Glad-Labs/poindexter/commit/b15d0d719d843f46fc6ea1b21f18e9b22308fa91))
* Active GPU VRAM management — pipeline controls model loading ([0833b27](https://github.com/Glad-Labs/poindexter/commit/0833b27745199e189418d8ea4ede92e76056fbef))
* Add 8 feedback loop tables — close the learn-from-outcomes gap ([99a46c3](https://github.com/Glad-Labs/poindexter/commit/99a46c331bcc6b39bf4b9b51d14295e9eea71d74))
* add AdSense meta tag to layout head for account verification ([5bec555](https://github.com/Glad-Labs/poindexter/commit/5bec555d1449b995529d2645a1f934fb4d6ba017))
* add agent permissions to Grafana system settings dashboard ([e403ab1](https://github.com/Glad-Labs/poindexter/commit/e403ab1dfd43e71dced9a16e7097139795470bc6))
* add CMS routes to worker for preview endpoint access ([e66098a](https://github.com/Glad-Labs/poindexter/commit/e66098a93f355132c34e82477dd4c99d231a3dd2))
* add Grafana + public site health probes to brain daemon ([82b63a7](https://github.com/Glad-Labs/poindexter/commit/82b63a779773b4dc4d2ee4f9e00e33efae3469b5))
* add local build-and-deploy script for Railway elimination ([2ffeb9c](https://github.com/Glad-Labs/poindexter/commit/2ffeb9c427281369b2442535beda44659dd351bd))
* add Matt's writing style reference for RAG voice customization ([0a7b2fa](https://github.com/Glad-Labs/poindexter/commit/0a7b2fac7e04ad8177f3db44a3c2edc0fb0504d8))
* add mobile-friendly HTML preview page at /preview/{token} ([6eabe83](https://github.com/Glad-Labs/poindexter/commit/6eabe8382ee514e420f8ac14d9cb6d388cba8949))
* agent permission system -- DB-driven access control ([dfeee75](https://github.com/Glad-Labs/poindexter/commit/dfeee751b1ff133bf097715efb903ee3de4175bd))
* alert auto-triage — system fixes problems before bothering humans ([31acb11](https://github.com/Glad-Labs/poindexter/commit/31acb110267626bafbf476d1d991dbc298ebb407))
* auto-create Gitea issues when health probes fail 3x ([0f6b332](https://github.com/Glad-Labs/poindexter/commit/0f6b332e877d4a5f8e00733042759db7e38f6a69))
* Auto-curation — reject low-quality posts before human review ([043704d](https://github.com/Glad-Labs/poindexter/commit/043704d1e5e93737cd3f3eade5adce06eb1a3b2c))
* auto-regenerate podcast RSS feed on R2 after publish ([08e9932](https://github.com/Glad-Labs/poindexter/commit/08e9932734627709bed33d974876efbe7e5c4f33))
* auto-schedule posts to prevent batch publishing ([259701a](https://github.com/Glad-Labs/poindexter/commit/259701a181e8610c701e996c78ebdebeee578cf3))
* auto-sync shared context from live DB state ([10b0823](https://github.com/Glad-Labs/poindexter/commit/10b08233f9550bbc5fbc0f9084b84d277538e546))
* auto-tuning thresholds + anomaly detection in idle worker ([bc8c259](https://github.com/Glad-Labs/poindexter/commit/bc8c259a728d48a886cf27e47276326b83742256))
* auto-upload media to R2 on publish ([#132](https://github.com/Glad-Labs/poindexter/issues/132)) ([1ef83c4](https://github.com/Glad-Labs/poindexter/commit/1ef83c44007ec9795159e1c1ba292352072ece4e))
* autonomous topic discovery — scrapes HN, Dev.to, DuckDuckGo ([2b16489](https://github.com/Glad-Labs/poindexter/commit/2b1648933c0c0dbe5064b9c86365aa941d065dca))
* British female voice (alba) + disable ElevenLabs + shared context fix ([9e418d8](https://github.com/Glad-Labs/poindexter/commit/9e418d896f56240822edba33a4587d88de18300f))
* category-specific SDXL styles + Cloudinary upload in pipeline ([d07e312](https://github.com/Glad-Labs/poindexter/commit/d07e312f3713ba48a134e4deb1af3356708c6d9b))
* Cloudflare R2 media hosting — zero egress fees ([d5f7309](https://github.com/Glad-Labs/poindexter/commit/d5f73095018c6fbb648d83e55aa5a4b47433c57b))
* comprehensive alerting — every blind spot gets an ear ([cef378e](https://github.com/Glad-Labs/poindexter/commit/cef378eb3a622a1dedbe3a82acdfaa0c92c3f25d))
* consolidate ALL crons into idle worker — zero manual scripts ([3e6bb3b](https://github.com/Glad-Labs/poindexter/commit/3e6bb3be4a88c79e9db54dcdedc0a164f547b552))
* Consolidate Grafana to 5 focused dashboards (3 free + 2 premium) ([cb6ec25](https://github.com/Glad-Labs/poindexter/commit/cb6ec25a4d964c55ea4adaabfad18f1c52021e4c))
* dashboards matched to System Health density + AIDA64 reference ([29dfdab](https://github.com/Glad-Labs/poindexter/commit/29dfdabae34f333810244eb92e56f1783e83e555))
* DB-configurable everything — remove hardcoded brand values and env vars ([1639e13](https://github.com/Glad-Labs/poindexter/commit/1639e138b386a37957a2253dcbab5f3c5493c77f))
* DB-configurable QA pipeline + media scripts + content quality hardening ([eb6ddbf](https://github.com/Glad-Labs/poindexter/commit/eb6ddbf55536ee1e9e2cc799e387e22495d90e9a))
* DB-first configuration — eliminate env var dependency ([9f7a928](https://github.com/Glad-Labs/poindexter/commit/9f7a92875bf0d5f19384802b622432178d7e2ef1))
* Decision logging foundation — every AI decision tracked for learning ([aab1511](https://github.com/Glad-Labs/poindexter/commit/aab15112bce7c02f7e73085e0cc5bb4cd51c71d1))
* dockerize worker — auto-restarts, survives reboots ([76db67c](https://github.com/Glad-Labs/poindexter/commit/76db67c6c9282c44a5776a97cae3a33d36218e83))
* editorial illustration style for featured images ([552ebf9](https://github.com/Glad-Labs/poindexter/commit/552ebf9d897e958ef477382d2c5d174b09f7d0a4))
* embedded audio/video players in post preview page ([04568a4](https://github.com/Glad-Labs/poindexter/commit/04568a49b0212308bea3fff2f923992f252b38b5))
* emergency-only cloud API mode with daily limits + Telegram alerts ([b1eb929](https://github.com/Glad-Labs/poindexter/commit/b1eb92907ecd81c98c5cb07f0e1ac084efe4d0fd))
* enhance Phone Command Center — 18 panels, full visibility ([572fabd](https://github.com/Glad-Labs/poindexter/commit/572fabdf0ea07d68ab05547aefd0d110d9bed96f))
* expand brand keywords to cover hardware and gaming pillars ([121cec8](https://github.com/Glad-Labs/poindexter/commit/121cec8364fbc43da06f7602317d65ec27f534a6))
* free web research — DuckDuckGo replaces Serper ($0 API cost) ([a98ce61](https://github.com/Glad-Labs/poindexter/commit/a98ce61813787b8fe99f3ed76ef342f61f3d0235))
* full system parameterization + pipeline config + MCP servers ([81bb466](https://github.com/Glad-Labs/poindexter/commit/81bb46672be98ba71595a3971e5496ca762787eb))
* Golden database seed script — 185 settings for new installs ([#164](https://github.com/Glad-Labs/poindexter/issues/164)) ([4113041](https://github.com/Glad-Labs/poindexter/commit/4113041af11bd6e6b7562687aa39d1f80f80acfd))
* GPU auto-detection + model recommendations ([602aefa](https://github.com/Glad-Labs/poindexter/commit/602aefa67081c48fd570f3b68ef79714432c5f13))
* GPU scheduler, Ken Burns video, voice rotation, deploy fix ([1eefe1f](https://github.com/Glad-Labs/poindexter/commit/1eefe1f36598398389b8284909bb8c89119614de))
* idle worker — system never stops working ([e0fa1b9](https://github.com/Glad-Labs/poindexter/commit/e0fa1b9797742256417338f59efb6171d8907169))
* idle worker auto-creates Gitea issues for all discoveries ([aa6f6ea](https://github.com/Glad-Labs/poindexter/commit/aa6f6ead341ad95ad6a3a1a1b6972ec10618116d))
* Image Decision Agent — LLM reasons about image placement + source ([2c813c2](https://github.com/Glad-Labs/poindexter/commit/2c813c2c837f6acb1cea5d42cdd0d53eb621e486))
* Image SEO metadata — alt text, dimensions, lazy loading ([ba7ca24](https://github.com/Glad-Labs/poindexter/commit/ba7ca24e6c354607286d5ecf9934773f57c16f14))
* improve podcast for natural speech + voice rotation pool ([9cd7634](https://github.com/Glad-Labs/poindexter/commit/9cd7634bae9c970948207c6be038d1b0c5841b6c))
* include preview link in approval notifications ([f11f31d](https://github.com/Glad-Labs/poindexter/commit/f11f31db361ecc940bebf038f7287b4fb2318cf6))
* IndexNow SEO ping, offline topics, stage timeouts, content quality ([68c9dd5](https://github.com/Glad-Labs/poindexter/commit/68c9dd59c086de1ebcadb0f6b750cc5af295475d))
* migrate brain daemon from Railway DB to local DB ([2964b14](https://github.com/Glad-Labs/poindexter/commit/2964b14c791935f941452d6efc9c3d86f0840284))
* migrate internal data to local DB — Railway for public content only ([88a53cf](https://github.com/Glad-Labs/poindexter/commit/88a53cf4555540bd4b3673c866fcb0b787a47023))
* migrate os.getenv to site_config for API keys and model config ([#47](https://github.com/Glad-Labs/poindexter/issues/47)) ([93ff7f0](https://github.com/Glad-Labs/poindexter/commit/93ff7f0f159642c6d42e982fc2866ce0cc1a0f30))
* migrate remaining os.getenv to site_config — batch 2 ([#47](https://github.com/Glad-Labs/poindexter/issues/47)) ([7fd9742](https://github.com/Glad-Labs/poindexter/commit/7fd9742aa2c394d39c61d00a50aa58d9e31d8e60))
* model shootout script + fix Ollama cost test ([5879b12](https://github.com/Glad-Labs/poindexter/commit/5879b12c95c06736eef87939a33eb28277a0834c))
* newsletter auto-send on post publish ([99bb4f6](https://github.com/Glad-Labs/poindexter/commit/99bb4f6781c81ff8cd81002eb53e972b2e59ea34))
* newsletter subscribe via Vercel serverless + Resend API ([aea89b0](https://github.com/Glad-Labs/poindexter/commit/aea89b024b0688d55ab70882c527cc41a7f03bb5))
...
* pipeline cost audit + URL validator + link health checker ([32da034](https://github.com/Glad-Labs/poindexter/commit/32da034a8ed9653957cc930e2c33448163f0b385))
* podcast TTS pipeline + Dev.to cross-posting ([ca378e9](https://github.com/Glad-Labs/poindexter/commit/ca378e9636a6d1dafbb19208112326a8a254e4f1))
* Premium prompt import/export pipeline ([80062ce](https://github.com/Glad-Labs/poindexter/commit/80062ce2b1b956ae3f2872e6372b3acc8fbfe2af))
...
* **qa:** topic-delivery and internal-consistency gates ([cfe767b](https://github.com/Glad-Labs/poindexter/commit/cfe767b629cf31792cd31705955f026b6b500aa1))
...
* **qa:** writer self-review pass + fix test failures from today's changes ([0b37719](https://github.com/Glad-Labs/poindexter/commit/0b37719379d60327783d89d807aa5123476cbf42))
* rebuild ALL dashboards — 75 panels, dense tables, zero flaky charts ([ac4e1c3](https://github.com/Glad-Labs/poindexter/commit/ac4e1c3e15579feecc6e223bdfd427c19d6e427b))
* rebuild Brain Operations dashboard — 18 panels, all raw data ([c3f2415](https://github.com/Glad-Labs/poindexter/commit/c3f2415e4b99665fb60aeea31b762d3eae482b35))
* rebuild LLM Analytics dashboard — 11 panels, no broken chars ([a141959](https://github.com/Glad-Labs/poindexter/commit/a14195965b43e94a6722be9894d25c33338d3781))
* Remove hardcoded brand values — site_config.require() for required settings ([0b305a3](https://github.com/Glad-Labs/poindexter/commit/0b305a3af6ee244a693a57aa1a873feff09b9e00))
* replace Cloudinary with R2 for image uploads ([#134](https://github.com/Glad-Labs/poindexter/issues/134)) ([0e9d1a2](https://github.com/Glad-Labs/poindexter/commit/0e9d1a2e2763cdff01a828979322848cb89cd7fb))
* Restore product page with disabled purchase buttons ([a84f8b4](https://github.com/Glad-Labs/poindexter/commit/a84f8b4e427effc08d4d71b59b32a4820fbd678d))
* rewrite all static pages — About, Terms, Privacy, Data Requests ([12ede93](https://github.com/Glad-Labs/poindexter/commit/12ede939c3f5eaf978c77da29e81954b1d559e7d))
* RSS feed for automated social posting (zero API cost) ([685ab65](https://github.com/Glad-Labs/poindexter/commit/685ab652db1b56910f963e70e2f6926f142fb1af))
* SDXL Lightning working + Ollama electricity cost fix ([f7d0f15](https://github.com/Glad-Labs/poindexter/commit/f7d0f1578142aec120b7d74b44ff8d49da1787d8))
* SDXL server auto-unloads after 1min idle to free VRAM for Ollama ([a07525a](https://github.com/Glad-Labs/poindexter/commit/a07525ad22e56935af4df4e07d8ffe27d7294d81))
* self-aware cost tracking + page_views sync ([789d260](https://github.com/Glad-Labs/poindexter/commit/789d2604b0911a682a6c973fca829d8f86704259))
* session 50 hardening — approval gate, media pipelines, brand voice ([5f7affb](https://github.com/Glad-Labs/poindexter/commit/5f7affb6ed4a119089288487b5bd9a50831e78af))
* set version to 0.9.0 and enable Release Please ([a3ad13c](https://github.com/Glad-Labs/poindexter/commit/a3ad13caca222a146a1031c1079e4068b1d7ee6f))
* Setup verification script — 24-point system health check ([#165](https://github.com/Glad-Labs/poindexter/issues/165)) ([63d4a61](https://github.com/Glad-Labs/poindexter/commit/63d4a616b9281316f71738e59f8b9011630026ab))
* split image styles — cinematic featured, all styles for body ([cb6af3f](https://github.com/Glad-Labs/poindexter/commit/cb6af3f4a73520c7ddb85b4fdef984f1c6ae2cd4))
* spoken English normalization for podcast TTS ([466c448](https://github.com/Glad-Labs/poindexter/commit/466c4485ddffecae516709bd6155a5458d59d410))
* stable podcast URLs, video RSS feed, episode proxy route ([e833729](https://github.com/Glad-Labs/poindexter/commit/e8337292a8cd11ca901e6c2a749ffd2add5b7bfc))
* Standalone SDXL image server — one GPU, unlimited callers ([8cfc0a3](https://github.com/Glad-Labs/poindexter/commit/8cfc0a393f5dd0dc36acb553f5431b43b022c626))
* static media hosting via Vercel CDN ([c4daf40](https://github.com/Glad-Labs/poindexter/commit/c4daf40206a9b25958a7dc977521ed50b4f03bfa))
* static podcast + video RSS feeds with R2 CDN URLs ([655cd49](https://github.com/Glad-Labs/poindexter/commit/655cd49e3c34c814e82514c3589636d11fb7d720))
* static RSS feed + sitemap generation from local DB ([14cbf59](https://github.com/Glad-Labs/poindexter/commit/14cbf599f96f5ea0b8128cfd6cf37c0a3bf26933))
* switch QA reviewer from gemma3:27b to glm-4.7-5090 ([504bd51](https://github.com/Glad-Labs/poindexter/commit/504bd51cb582f36156bda46a348163e3b682a762))
* sync newsletter subscribers from cloud to local (task [#18](https://github.com/Glad-Labs/poindexter/issues/18)) ([73ba6b1](https://github.com/Glad-Labs/poindexter/commit/73ba6b123722ddd0b40c7b3e5854188d94394c64))
* **tasks:** on-demand topic discovery endpoint ([f6597f2](https://github.com/Glad-Labs/poindexter/commit/f6597f21b4b1e6f267396cbb0eb5751962e8e483))
* title diversity — avoid repetitive patterns in content pipeline ([677d8a8](https://github.com/Glad-Labs/poindexter/commit/677d8a8476b00a5fa19dd530eb03d41d189f7072))
* title originality check via DuckDuckGo before finalizing ([1b5e0fc](https://github.com/Glad-Labs/poindexter/commit/1b5e0fc3567d3c4e339889fbb70bbde91cf4f458))
* track real electricity costs for local Ollama inference ([5394d2a](https://github.com/Glad-Labs/poindexter/commit/5394d2ac47c5d6bd1ca9d27305cc3f5aa6a052d4))
* Update product page — Sovereign Media Stack positioning ([6088bd9](https://github.com/Glad-Labs/poindexter/commit/6088bd9dd5bed09d7a9224732b6103232110bb9f))
...
* weekly content QA checker + 22 posts retitled + 12 claims fixed ([b3fe0b2](https://github.com/Glad-Labs/poindexter/commit/b3fe0b2d395dfa0b82a081facb66b81260b42956))
* wire permission checks into MCP server set_setting tool ([a735534](https://github.com/Glad-Labs/poindexter/commit/a7355347997b366a64f53e3656b6f0806b0b4dab))
* wire topic discovery into idle worker (every 8 hours) ([d13a770](https://github.com/Glad-Labs/poindexter/commit/d13a770c382bcc9ba122f88788768ac7737d076a))
* worker pool flip — .pool = local DB for internal ops ([bfe694e](https://github.com/Glad-Labs/poindexter/commit/bfe694e71f57063512cc2c2dd907d147a8ffe498))


### Bug Fixes

* 3 P0 site bugs + P1 pipeline crash ([67b5a3e](https://github.com/Glad-Labs/poindexter/commit/67b5a3e0aa8fec3dee32fc41919abaf8e364e1ab))
* 5 more test failures + stop phantom Telegram notifications ([c2f5322](https://github.com/Glad-Labs/poindexter/commit/c2f5322814460f2bfb056723b44d7cd0c43580ea))
* 6 pipeline hardening fixes — broken, fragile, missing ([1ca8023](https://github.com/Glad-Labs/poindexter/commit/1ca8023fd9c4daac1f4c04053bbbb49acaeeb6ac))
* add canonical tag to /posts index page ([86f308e](https://github.com/Glad-Labs/poindexter/commit/86f308ea00efc8f27e0684f05838b2f0c82e6181))
* add cover_image_url to PATCH allowed fields, fix ISR revalidation URL ([4de195a](https://github.com/Glad-Labs/poindexter/commit/4de195a2575a33ca2489f97b7cd1c1174679fb4b))
* Add dev tool keywords to brand filter (redis, terraform, languages) ([5131568](https://github.com/Glad-Labs/poindexter/commit/51315687204185792981ddec2f529cafd4dbd5db))
* add exc_info=True to all error/warning logs in brain daemon + big_brain ([dc0b037](https://github.com/Glad-Labs/poindexter/commit/dc0b037684860a6b3f9482b151b8a1d865ad3d2b))
* add missing og-image.jpg for social sharing ([2a20485](https://github.com/Glad-Labs/poindexter/commit/2a20485721bf46879130d63e6efc1d8508e6294e))
* add R2 CDN to Next.js image remotePatterns ([d89f4ea](https://github.com/Glad-Labs/poindexter/commit/d89f4ea77c252ece87e76c3d33b04a0539b478fb))
* add redirects for remaining WordPress 404s (woocommerce, feed, site-logo) ([8189ca2](https://github.com/Glad-Labs/poindexter/commit/8189ca228edaf29836761955dea53903ed833f6a))
* add User-Agent to Dev.to API calls (403 Forbidden Bots) ([1ad9b0a](https://github.com/Glad-Labs/poindexter/commit/1ad9b0a694e57b3a299c302d89be65b1bf1227d9))
* ads.txt — replace placeholder with real AdSense publisher ID ([16866f5](https://github.com/Glad-Labs/poindexter/commit/16866f57f1ffbc5271d41d66eeae4780e2435878))
* Anti-hallucination — detect fabricated personal experiences ([571add6](https://github.com/Glad-Labs/poindexter/commit/571add6c82154471883dc8e377c76e32e6a995e5))
* **approval:** approve → immediate go-live, drop broken staging-draft flow ([3f60ec4](https://github.com/Glad-Labs/poindexter/commit/3f60ec4c3f448669fdc84988c0cf3b4e33a0d3f7))
* approve now auto-publishes by default (closes [#51](https://github.com/Glad-Labs/poindexter/issues/51)) ([87b8042](https://github.com/Glad-Labs/poindexter/commit/87b8042f43152511d43d600f0d69bc4e049acad4))
...
* audit-log + brain-ops time column aliases (Grafana parsing) ([4e730d0](https://github.com/Glad-Labs/poindexter/commit/4e730d04de9bc7ceb153b48651c46198681b3718))
* auto-embed falls back to local DB when no cloud DSN set ([0b71a65](https://github.com/Glad-Labs/poindexter/commit/0b71a65145fff765d6ac7df77eeb587f9bf6e5bf))
* auto-embed loads Gitea creds from app_settings DB ([ee798f1](https://github.com/Glad-Labs/poindexter/commit/ee798f17b003028e0e1e3e52e05105572438d302))
* Auto-publish threshold 0 now means disabled, not publish-everything ([50955dd](https://github.com/Glad-Labs/poindexter/commit/50955ddf67ba47232c46d77a64cc4cc0816a35ba))
* Bootstrap auto-generates secrets, validates Ollama, documents models ([#155](https://github.com/Glad-Labs/poindexter/issues/155)) ([1c7e0d0](https://github.com/Glad-Labs/poindexter/commit/1c7e0d0da3c5807f4c109dfb553ce6184325f8f4))
* **bootstrap:** land 4 P0 fixes from the dogfood install pass ([#185](https://github.com/Glad-Labs/poindexter/issues/185)) ([f690ef5](https://github.com/Glad-Labs/poindexter/commit/f690ef5d3ac1048b50f606f22938fb57a032fbb6))
* Brain daemon runs openclaw doctor --fix every 15 minutes ([628d0db](https://github.com/Glad-Labs/poindexter/commit/628d0db6f9856aba0c49a738c29b6b7dbb9b70f3))
...
* brand relevance uses word-boundary matching, remove generic 'solo' ([4e8460a](https://github.com/Glad-Labs/poindexter/commit/4e8460acfc8799f1a55a48d1395333379cdac6c1))
* category assignment — respect requested category, expand matching ([52d1e01](https://github.com/Glad-Labs/poindexter/commit/52d1e01f503391ee2c311f69212bd29bb64de36c))
* clear SERPER_API_KEY env in no-key tests ([3575d65](https://github.com/Glad-Labs/poindexter/commit/3575d654c1cf4f08e3903d52c259eef3bbc61b6b))
* command-center + pipeline-overview broken queries ([98f977c](https://github.com/Glad-Labs/poindexter/commit/98f977cb029029e730c57615b229b0322bbbbbce))
* Consolidate notifications — one message per task, no duplicates ([3b040a2](https://github.com/Glad-Labs/poindexter/commit/3b040a25ce0ebb61c42929cbbff46b7dace03c8a))
* **content-pipeline:** SDXL Lightning server, research-grounded QA, image CSS ([2f8cc58](https://github.com/Glad-Labs/poindexter/commit/2f8cc583a64109738a4f28c24210304ec672056f))
* correct manifest version format (remove leading space) ([18e6be9](https://github.com/Glad-Labs/poindexter/commit/18e6be9b0c0df32ccdb3ab86b4ce7ff9d49d7169))
* correct parameter name in API request (data not json_data) ([559970e](https://github.com/Glad-Labs/poindexter/commit/559970e8226bb15617b6ef8064406325d31904e7))
* correct quality_evaluations column names in phone dashboard ([48602d6](https://github.com/Glad-Labs/poindexter/commit/48602d6c7353a42950cf37baa173d7995582d9a6))
* Daemon uses live topic discovery instead of exhausted templates ([7cdbef6](https://github.com/Glad-Labs/poindexter/commit/7cdbef66bd028c7911b69a41d4e9512edc3fcb78))
* deduplicate idle worker Gitea issue creation ([8b9ede8](https://github.com/Glad-Labs/poindexter/commit/8b9ede810ea5c094aa5866ff77682fbac6a25870))
* dev CI build — add NEXT_PUBLIC env vars for Next.js build step ([9caf433](https://github.com/Glad-Labs/poindexter/commit/9caf433ebde8dd003a29558e398230571f120282))
* Discord notifications use direct webhook instead of OpenClaw ([df189dc](https://github.com/Glad-Labs/poindexter/commit/df189dcb8548d0bc8e780baa8044cf85a83ac822))
* Diversify topic templates — no more "Building Production-Ready X" ([70b78ed](https://github.com/Glad-Labs/poindexter/commit/70b78edf2540d54de4522026ef5d6436f7b7c927))
...
* Don't auto-retry rejected tasks — only retry failures ([a4487c8](https://github.com/Glad-Labs/poindexter/commit/a4487c8096428229ce63ac0f538372465fa7f513))
* duplicate model names + nvidia exporter Docker connectivity ([4f7e0d4](https://github.com/Glad-Labs/poindexter/commit/4f7e0d41bb8538bfa2878350438151860fa56c10))
* Featured image uses SDXL server instead of internal diffusers ([56c395a](https://github.com/Glad-Labs/poindexter/commit/56c395a3c06dc970cf53b14ffd976e2772e455f8))
* filter HN product launches from topic discovery, limit podcast GPU context ([ddbea0c](https://github.com/Glad-Labs/poindexter/commit/ddbea0c80d9bfa9dd9ef8aadac99d43cd25243e9))
* frontend audit fixes — COOP header, JSON-LD, meta descriptions ([67581e8](https://github.com/Glad-Labs/poindexter/commit/67581e8c25ffe2f44387c07cd2211b4023284a0a))
* fully mock LLM + TTS in TestPodcastService tests ([8e6e4db](https://github.com/Glad-Labs/poindexter/commit/8e6e4db302415bb44d9fe4703bc073fde496df8d))
* GPU metrics time column alias ([3fc86a4](https://github.com/Glad-Labs/poindexter/commit/3fc86a42ab9886e63da8ef6b373c3fc4b99e2400))
* Grafana dashboard time ranges — default to 7 days ([9ecaa90](https://github.com/Glad-Labs/poindexter/commit/9ecaa9007109609c4f9b333ae2d61af4cbe31c67))
* Grafana dashboards — explicit datasource targets + bar charts ([f41e756](https://github.com/Glad-Labs/poindexter/commit/f41e75657f6a0d2fa271607340f84e81b8fde49f))
* Grafana datasource type + defaultDatabase in provisioning ([e5a7e19](https://github.com/Glad-Labs/poindexter/commit/e5a7e191eb5120bf0d0175ae18334d68e94eca65))
* Handle SDXL JSON response for inline images — was expecting raw bytes ([be62103](https://github.com/Glad-Labs/poindexter/commit/be621039332e2eea508e726b7e52a110b936fd4b))
* health probe alerts — affiliate column name + Pexels key check ([eaf2646](https://github.com/Glad-Labs/poindexter/commit/eaf264657b7d9756f0d382d595c4918b7d58683b))
...
* Image Decision Agent fails loud — no heuristic fallback ([7fd4d9d](https://github.com/Glad-Labs/poindexter/commit/7fd4d9d4970e5a453f0ad7d9a6b4641b47265809))
* Image Decision Agent handles qwen3 thinking models correctly ([b5350f9](https://github.com/Glad-Labs/poindexter/commit/b5350f998ebed6f222b4ce45aab31d0c0d26476d))
* Image Decision Agent uses /api/chat for thinking models ([7b1db63](https://github.com/Glad-Labs/poindexter/commit/7b1db6363864738cbe0cd500b9f967f5c7c8a0f0))
...
* Improve content quality for AdSense — prompts, thresholds, curation ([8a4a8c6](https://github.com/Glad-Labs/poindexter/commit/8a4a8c662d38052a612c03030e6a3df773b29505))
* increase bar chart sizes for readability — Table Sizes + Dead Tuples ([488f81a](https://github.com/Glad-Labs/poindexter/commit/488f81a6ebeaca30126fce3aacb8d9ee7d811ebd))
* increase draft generation timeout 5min → 8min ([ca68a71](https://github.com/Glad-Labs/poindexter/commit/ca68a7154948be8f4a137870982f7cead8d84110))
* increase footer link tap targets for mobile accessibility (py-2) ([805efb7](https://github.com/Glad-Labs/poindexter/commit/805efb752b4aa02d265387e96af12aac840f8656))
* kill Gemini fallback — zero cloud API costs now for real ([9451d99](https://github.com/Glad-Labs/poindexter/commit/9451d99df64aa6b94f11c1f95dace9cb9efb5893))
* make topic dedup window DB-configurable (qa_topic_dedup_hours) ([cda23cc](https://github.com/Glad-Labs/poindexter/commit/cda23ccf3d0a35c245b134c13d6f2f9d1e30b63a))
* MCP server defaults to local worker instead of dead Railway ([6c52612](https://github.com/Glad-Labs/poindexter/commit/6c5261276a05a9ec5a8a49791dc53126146c1337))
* **migrate:** correct service name + temp-admin pattern for user rename ([897b8f9](https://github.com/Glad-Labs/poindexter/commit/897b8f9b0f1d714a5cd2fa1d4669e2863c3e35ce))
* mock _generate_with_voice in podcast empty content test ([50c39e7](https://github.com/Glad-Labs/poindexter/commit/50c39e7b21b6d4c59fa8cbdb0e298fc5fbf19fa8))
* mock edge_tts in podcast test to prevent network hang ([f6a3abe](https://github.com/Glad-Labs/poindexter/commit/f6a3abe6792d4727654dfa023a23c757a4d9afeb))
* mock publish_service in all TestPublishTask tests (autouse fixture) ([a5f6058](https://github.com/Glad-Labs/poindexter/commit/a5f6058a3b35ad9246bcd0cea403567c64141aa2))
* **model_consolidation:** HuggingFaceAdapter NameError crash + add tests ([0e5b04c](https://github.com/Glad-Labs/poindexter/commit/0e5b04c2bd06352a26e11e34ee9b8071c4dade14))
* move ML deps (torch, diffusers, peft) to optional extras ([df112c2](https://github.com/Glad-Labs/poindexter/commit/df112c22db612d5255a0af08537ecc7b3415356b))
* notification routing — Discord=everything, Telegram=critical only ([fe7e439](https://github.com/Glad-Labs/poindexter/commit/fe7e4398d550e32a424bc8f7d74cbe9b4b9a605a))
* Ollama electricity cost tracking — was logging $0 for every call ([3122318](https://github.com/Glad-Labs/poindexter/commit/31223182857f31538f3390c6b00b77e8b1df932a))
* Ollama is NOT free — track electricity costs per token ([e813427](https://github.com/Glad-Labs/poindexter/commit/e81342788507c6ef74946e681e6bffc2bf1bed63))
...
* P0 cost guard bypass — block cloud API when budget check fails ([c6131ce](https://github.com/Glad-Labs/poindexter/commit/c6131cec5371c91ea89f1e92e16a4a2228c1bc4a))
* P2 cleanup — Prometheus for GPU metrics, About page, DB backup, scheduled tasks ([382f9b8](https://github.com/Glad-Labs/poindexter/commit/382f9b851ca21c5f3f3cb47a66c94e37adadd01a))
* page-views dashboard — category performance query ([2133fa8](https://github.com/Glad-Labs/poindexter/commit/2133fa8ff763715db8b6167048386e8871f1f8c0))
* phone dashboard — GPU temp + Ollama activity panels ([ea395fa](https://github.com/Glad-Labs/poindexter/commit/ea395fab2f5ab4a8fed4d59dc04869c93316d36e))
* phone dashboard 7-Day Spend -&gt; table (was timeseries) ([1ac5df2](https://github.com/Glad-Labs/poindexter/commit/1ac5df27736b47cf099b826584ef103fffdd4b53))
* Pipeline orchestrates GPU mode switching between LLM and image stages ([0ae1024](https://github.com/Glad-Labs/poindexter/commit/0ae102452bcb8d35fa8fb9aa9ab26f5d4bff2849))
* pipeline success rate (completed→published) + GPU temp numeric ([4f23e30](https://github.com/Glad-Labs/poindexter/commit/4f23e307cc06e4792731c0365c3c83bc57f38039))
* preview token bug + 49 new tests for podcast/video/request_id ([1f97453](https://github.com/Glad-Labs/poindexter/commit/1f9745355e1efb772031247f61832bf1c07d2800))
* preview URLs use Tailscale IP for mobile access ([1fc725b](https://github.com/Glad-Labs/poindexter/commit/1fc725b811da2d390a112fb82ab9ba4a889e5e2b))
* prioritize HX1500i wall power over software estimate for electricity tracking ([e2fa59b](https://github.com/Glad-Labs/poindexter/commit/e2fa59be2d3fbae83676b6c6875a1a5e25d1a561))
* properly mock all async methods in idle worker test ([0cb0375](https://github.com/Glad-Labs/poindexter/commit/0cb037554e5091dd7c0b6c8ffd42ead5b0f9d1e7))
...
* R2 probe handles 403 gracefully (R2 blocks HEAD, 403 = reachable) ([37c074a](https://github.com/Glad-Labs/poindexter/commit/37c074ac0e4d2a3dd5088649593c398c188e4915))
* R2 URL loading — use lazy lookup, add missing import ([27d79e0](https://github.com/Glad-Labs/poindexter/commit/27d79e0a719a7144776d30e409ba92b61bbaecaf))
* Re-add gaming and PC hardware to brand filter ([b6279a7](https://github.com/Glad-Labs/poindexter/commit/b6279a7ad2bb4397bc76a41b91510b5df2c1bf38))
* re-enable newsletter, privacy, approval routes — were in _DISABLED_ROUTES ([d920e96](https://github.com/Glad-Labs/poindexter/commit/d920e965dfa710c27c60ab2ec1e2f235a8f5ae92))
* Reject endpoint accepts UUID prefix (8+ chars) ([505d18a](https://github.com/Glad-Labs/poindexter/commit/505d18a10587acfe58e2abebca5b83dce3e55179))
* release-please target-branch main (was staging) ([eeee079](https://github.com/Glad-Labs/poindexter/commit/eeee079f677a18013793e7e2e020a8180e04b0ae))
* remove all Grafana Cloud references — using local Grafana now ([cf3f221](https://github.com/Glad-Labs/poindexter/commit/cf3f221f9d5b887f591b067b4e3af7709bd73f7d))
* remove duplicate release-type from action (manifest mode handles it) ([7c108de](https://github.com/Glad-Labs/poindexter/commit/7c108debe9bb9297a4e1f3b4ac042920c49b4714))
* Remove false claims from product page and README ([3b153fb](https://github.com/Glad-Labs/poindexter/commit/3b153fbc9ded86c344b13734d9c4fa8193448ce4))
* Remove hardcoded paths and secrets from docker-compose ([#155](https://github.com/Glad-Labs/poindexter/issues/155)) ([bf9fab3](https://github.com/Glad-Labs/poindexter/commit/bf9fab31a7d54981bff6b81aa02ca48a56ddabe8))
* remove placeholder defaults from MCP server + newsletter ([02b946f](https://github.com/Glad-Labs/poindexter/commit/02b946f00468bd1fa8da811fb761579ed0b84523))
* Remove Railway production references from infrastructure ([5143e90](https://github.com/Glad-Labs/poindexter/commit/5143e904253da77ff110d3990477321c786c279a))
* remove t.color from tag query (column doesn't exist on cloud DB) ([7e33c02](https://github.com/Glad-Labs/poindexter/commit/7e33c023a5b2102a0c427e28a03a011cb8907b65))
* replace \$__timeFilter with explicit BETWEEN for time-series panels ([72b8fa0](https://github.com/Glad-Labs/poindexter/commit/72b8fa0aef481edab63020d8d36de9a87956d042))
* reset package.json version to 0.1.0 (was 0.9.0) ([21db4f6](https://github.com/Glad-Labs/poindexter/commit/21db4f642d35c2afbe0a03c120fdab8596ab0a24))
* reset release-please manifest to v0.1.0 (was 0.9.0 causing 1.0.0 bumps) ([c9cdf6e](https://github.com/Glad-Labs/poindexter/commit/c9cdf6e6106ceca9f99842d4449b03f9f626245a))
* resolve 2 hanging unit tests (publish + idle worker) ([de55e9b](https://github.com/Glad-Labs/poindexter/commit/de55e9b1291e8e7ca666fb957ced37669ca50676))
* resolve 3 failing unit tests (url_validator, image_service) ([3a0c291](https://github.com/Glad-Labs/poindexter/commit/3a0c2915dcf9ac4e7bd17a7a9b734c152e7a38ab))
* resolve 9 test failures from session 50 changes ([4bf3a47](https://github.com/Glad-Labs/poindexter/commit/4bf3a47b67f486d706ed8e9cdf2582243937c143))
* resolve last 4 test failures + add pgAdmin to local stack ([a4b5e32](https://github.com/Glad-Labs/poindexter/commit/a4b5e32f6bae2504cf69c50d6d0a81bd8a6c28b8))
* return resolved topic in task creation response ([d859b28](https://github.com/Glad-Labs/poindexter/commit/d859b28b5d1a0740aeb3ee90ba6094995d41c923))
* rewrite cookie policy — accurate, human-readable, April 2026 ([7433480](https://github.com/Glad-Labs/poindexter/commit/74334807b33669db1e4318aca59bb2d9acc5f606))
* Route notifications through OpenClaw — no bot tokens in containers ([355c589](https://github.com/Glad-Labs/poindexter/commit/355c589de98a5f12dbc278fa591904131745e70f))
* Run openclaw doctor from host daemon, not Docker brain ([d8e756f](https://github.com/Glad-Labs/poindexter/commit/d8e756f079f1bc62083d8098044c8990acfa4fa0))
* SDXL server keeps turbo with better quality settings ([ad62507](https://github.com/Glad-Labs/poindexter/commit/ad6250786d0d2caf6bc730ae473453c0c4a0dadc))
* SDXL server total_mem → total_memory (torch API change) ([170ac41](https://github.com/Glad-Labs/poindexter/commit/170ac41cc896d1606578ca344532bf46e9a84310))
* SEO audit — canonicals, RSS autodiscovery, iTunes tags ([0d478df](https://github.com/Glad-Labs/poindexter/commit/0d478dfd6531089e693dea39784fd51d22319549))
* set versioning-strategy to always-bump-minor (prevents 1.0.0) ([3be54f6](https://github.com/Glad-Labs/poindexter/commit/3be54f634cd81420985a40ceea661aedebf8aa01))
* skip E2E tests when backend API unavailable ([#46](https://github.com/Glad-Labs/poindexter/issues/46)) ([02bfa59](https://github.com/Glad-Labs/poindexter/commit/02bfa59370a3536f2e1be1b872464de17a7cb550))
...
* skip Telegram for low-quality tasks (&lt; 50 score) ([d3917a9](https://github.com/Glad-Labs/poindexter/commit/d3917a9e89ff1a67ed26daf13953fee3640fd4fb))
* **social_poster:** lazy-load discord channel ID at first call, not import time ([a3faf5f](https://github.com/Glad-Labs/poindexter/commit/a3faf5fa5c95303a6cf81174e8f176426f1b7b2c))
* strip AI-generated resource sections + ban AI cliche openers ([adbecfc](https://github.com/Glad-Labs/poindexter/commit/adbecfc678c29c5f038d859f2a1220c750ac669c))
* strip leftover [IMAGE-N] placeholders from content before publish ([041691a](https://github.com/Glad-Labs/poindexter/commit/041691a4db43e09ae039652982f778a324ee48ad))
* Strip qwen3 thinking tags from Image Decision Agent response ([459d61a](https://github.com/Glad-Labs/poindexter/commit/459d61ac24dd679087375ce62cc77d29e37b61e8))
* stronger topic dedup — bidirectional 50% word overlap, checks all existing ([01e7538](https://github.com/Glad-Labs/poindexter/commit/01e753861edffe650a633a5b69db118ede571730))
* Switch SDXL from turbo to Lightning — quality over speed ([9de32ca](https://github.com/Glad-Labs/poindexter/commit/9de32ca6b1690607432ed34e58baf80d34668a87))
* Sync script strips all private/premium content ([df7fbe9](https://github.com/Glad-Labs/poindexter/commit/df7fbe9bc504cafb4f0cdab4905929096c71ca70))
* task preview renders markdown as HTML + adds id field ([e39ae74](https://github.com/Glad-Labs/poindexter/commit/e39ae746bca5deafb932445136c55aebe40f50ce))
* **task-executor:** auto-retry honors human rejection ([acdd164](https://github.com/Glad-Labs/poindexter/commit/acdd16403b9865c35799e9c9f8640830d1e76674))
* **task-executor:** rejection workflow semantics ([bc0450f](https://github.com/Glad-Labs/poindexter/commit/bc0450f118daeb9fff1e0b5e3575a9c7c1f392b4))
* Tighten topic discovery brand filter — reject off-brand HN scrapes ([0f74751](https://github.com/Glad-Labs/poindexter/commit/0f74751c0f5b53bcb046883ce006ba7b45c957e1))
* **timeouts:** close remaining gaps found during hardcoded-config audit ([3690abf](https://github.com/Glad-Labs/poindexter/commit/3690abfd648298d12b43d7515f4fd76823f7f5f5))
* **timeouts:** DDGS asyncio.wait_for, model_consolidation AsyncClient, SEO pings ([f0c6cc0](https://github.com/Glad-Labs/poindexter/commit/f0c6cc0b29853a2b01efeceb55aa92bfe50dc989))
* **timeouts:** explicit per-call caps on every SDXL and GPU call site ([4168f87](https://github.com/Glad-Labs/poindexter/commit/4168f87bf6f69afc8b59af585351f2ce7a393c0e))
* **timeouts:** finish hygiene pass on medium-risk call sites + audit log promoted score ([2bb77af](https://github.com/Glad-Labs/poindexter/commit/2bb77afae53abc296a71196334b1094efb84b571))
* **timeouts:** OllamaClient default + explicit wait_for on qa gates ([0bfd438](https://github.com/Glad-Labs/poindexter/commit/0bfd4389370ee2ec153ab9ae91bd76a180864564))
* topic dedup checks 48h of all tasks, auto-topic resolves at creation ([0f6ab82](https://github.com/Glad-Labs/poindexter/commit/0f6ab82eebd428082726f5b6cf493f46f20bf0b6))
* topic discovery queue failing — explicit type casts for INSERT params ([1839c4a](https://github.com/Glad-Labs/poindexter/commit/1839c4ac855bf6adcb02c62d1161961acdb84cba))
* traffic anomaly alert used wrong column (viewed_at → created_at) ([6ec34d0](https://github.com/Glad-Labs/poindexter/commit/6ec34d04d45120f0f7ed5e184986c4140cdc54eb))
* Translate SDXL host paths to container paths for inline images ([528a6a4](https://github.com/Glad-Labs/poindexter/commit/528a6a45880c4929076cba9c3009d8307bc22c64))
* TTS pronunciation — GitFlow, GitHub, FastAPI, PostgreSQL, etc ([c9d566a](https://github.com/Glad-Labs/poindexter/commit/c9d566a798e39fb5ad9acf57001034d56bd0201e))
* update route count test — 11 coordinator routes now (was 8) ([aa6024b](https://github.com/Glad-Labs/poindexter/commit/aa6024b55e1b5f05a66e5b0bbd0a781c1792fe82))
* update route manifest test counts for podcast routes ([2823de5](https://github.com/Glad-Labs/poindexter/commit/2823de544d5384bfa0be7c501ec986007a27b75e))
* Update topic discovery tests for tighter brand filter ([48a29a6](https://github.com/Glad-Labs/poindexter/commit/48a29a6f0ee24196f9dce1dfc6a91994c55ca303))
* update Twitter card handle to @_gladlabs ([9898055](https://github.com/Glad-Labs/poindexter/commit/989805531093bbf59ca137132910b5c0cf9f08c4))
* Vercel build error — invalid redirect pattern for gemini_generated_image ([be8ba2d](https://github.com/Glad-Labs/poindexter/commit/be8ba2d3d1a978b20a01e6412ba78c803c8a9ccf))
* versioned podcast CDN paths for cache-busting ([28b71ef](https://github.com/Glad-Labs/poindexter/commit/28b71ef926c8ba9aa693f121e4bc71db0800962c))
* ViewTracker skips when no public API URL configured ([d1be230](https://github.com/Glad-Labs/poindexter/commit/d1be23062872624eed7ee33116ed43faa5c6a6cf))
* Woodpecker Gitea URL — use Docker hostname (gitea:3000 not localhost:3001) ([8df03ce](https://github.com/Glad-Labs/poindexter/commit/8df03ce003f7674629fa5dbf5364b2cffc54640d))
* Woodpecker YAML — status field needs array format in v3 ([a0f380f](https://github.com/Glad-Labs/poindexter/commit/a0f380fcba741d176a8fed30a8bf28aa97f2c788))


### Code Refactoring

* content_validator + privacy_routes to site_config (DB-first) ([f9624f7](https://github.com/Glad-Labs/poindexter/commit/f9624f715095d0b9db129e3ee0ed3c9bd3526170))
* final os.getenv migration — task_executor, big_brain, admin, main ([048d0bb](https://github.com/Glad-Labs/poindexter/commit/048d0bb2565ceed825f02551f0f7956f5956f94a))
* **logging:** unify logger creation on services.logger_config.get_logger ([6c57e32](https://github.com/Glad-Labs/poindexter/commit/6c57e3267ba40b9e389525aa1aa87c01236ff98f))
* migrate services from os.getenv to site_config (DB-first) ([0d62ad0](https://github.com/Glad-Labs/poindexter/commit/0d62ad0508134a0a0b9da0e2f6a7f6fcf89bff55))
* move 6 hardcoded configs to app_settings (DB-configurable) ([2e82bd5](https://github.com/Glad-Labs/poindexter/commit/2e82bd5ad87764f8d843be3ba0c11b0a704a5390))
* **schemas:** migrate class-based Config to ConfigDict (Pydantic V2) ([fb87de5](https://github.com/Glad-Labs/poindexter/commit/fb87de53452402d545a2987035fd99672a64920e))
* social_poster + url_validator to site_config (DB-first) ([0e47fa3](https://github.com/Glad-Labs/poindexter/commit/0e47fa3f64e3d519ed06ac4b7ebb7928004c7339))
