...
| `tap` | `external_taps` | `services/integrations/tap_runner.py` | Pull external data on a schedule (HackerNews, Dev.to, GA4, GSC, YouTube reach, Singer subprocesses). |
...
<AccordionGroup>
  ...
  <Accordion title="tap surface">
    ...
    - [`tap.youtube_reporting`](/docs/integrations/tap_youtube_reporting) — YouTube Reporting API bulk reports (thumbnail impressions + CTR) into `external_metrics`
  </Accordion>
