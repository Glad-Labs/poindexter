...
class TestSummarization:
    ...
    def test_run_returns_summary(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
    ...
    def test_run_calls_llm_generate_summary(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
    ...
    def test_run_formats_prompt_correctly(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
    ...
    def test_run_with_different_templates(self, summarizer_agent, sample_long_text, mock_llm_client):
...
class TestEdgeCases:
    ...
    def test_handles_whitespace_only(self, summarizer_agent, sample_prompt_template, mock_llm_client):
    ...
    def test_handles_very_short_text(self, summarizer_agent, sample_prompt_template, mock_llm_client):
...
class TestErrorHandling:
    ...
    def test_handles_llm_error(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
    ...
    def test_handles_invalid_prompt_template(self, summarizer_agent, sample_long_text, mock_llm_client):
    ...
    def test_handles_network_timeout(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
...
class TestSummaryQuality:
    ...
    def test_summary_shorter_than_input(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
        """Test that summary is shorter than input (when mocked realistically)"""
        mock_llm_client.generate_summary.return_value = "AI is transforming healthcare with ML and NLP."
    ...
    def test_handles_very_long_text(self, summarizer_agent, sample_prompt_template, mock_llm_client):
...
class TestSummarizerAgentPerformance:
    ...
    def test_summarization_performance(self, summarizer_agent, sample_long_text, sample_prompt_template, mock_llm_client):
    ...
    def test_multiple_summarizations(self, summarizer_agent, sample_prompt_template, mock_llm_client):
