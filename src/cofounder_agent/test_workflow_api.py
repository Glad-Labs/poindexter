...
def main():
    ...
    try:
        workflow_def = {
            ...
            "phases": [
                {"index": 0, "name": "research", "user_inputs": {"topic": "Test Topic", "focus": "Testing"}},
                {"index": 1, "name": "draft", "user_inputs": {"prompt": "Draft content", "content": "Test content", "target_audience": "Testers", "tone": "casual"}},
                {"index": 2, "name": "assess", "user_inputs": {"content": "Test", "criteria": "Good", "quality_threshold": 0.7}},
            ]
        }
        resp = requests.post(
    ...
    if workflow_id:
        ...
        try:
            exec_payload = {
                "initial_inputs": {"user_request": "Test execution"}
            }
            resp = requests.post(
            ...
            if resp.status_code in [200, 201]:
                ...
                if summary:
                    ...
                    print(f"        Total Time: {summary.get('total_execution_time_seconds', 0):.4f}s")
