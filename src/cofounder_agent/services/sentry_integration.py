...
class SentryIntegration:
    ...
    def initialize(cls, app: FastAPI, service_name: str = "cofounder-agent"):
        ...
        if not sentry_dsn:
            ...
            logger.info("   To enable error tracking, set: export SENTRY_DSN='https://key@sentry.io/project-id'")
        ...
        try:
            ...
            sentry_sdk.init(
                ...
                profiles_sample_rate=0.1 if environment == "production" else 1.0,  # Profile 10% of transactions
    ...
    @classmethod
    def capture_exception(cls, error: Exception, context: Optional[dict] = None, level: str = "error"):
        """
    ...
    @classmethod
    def add_breadcrumb(cls, category: str, message: str, level: str = "info", data: Optional[dict] = None):
        """
