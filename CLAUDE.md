...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-08-12)
...
- 179 live posts on gladlabs.io (353 posts total; 2,029 pipeline_tasks across all generation runs)
...
- 67,258 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
