...
class PubSubClient:
    def __init__(self, project_id: str, topic_id: str, subscription_id: str, orchestrator):
    ...
    def listen_for_messages(self):
        ...
        with self.subscriber:
            try:
                ...
                logging.error(f"An error occurred while listening for messages: {e}", exc_info=True)
