...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-07-31)
...
- 164 live posts on gladlabs.io (338 posts total; 1,992 pipeline_tasks across all generation runs)
...
- 56,590 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
