...
| :----------------------- | :------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Monorepo**             | **GitHub (glad-labs-website)**   | Centralizes all code (Co-founder Agent, Public Site) using npm workspaces for isolated dependency management.                                       |
...
- **/src/cofounder_agent/**: Central orchestrator with 26 route modules and 118 service modules.
...
- **[✓] Operations Platform:** OpenClaw for task management and agent monitoring; Grafana for performance dashboards.
