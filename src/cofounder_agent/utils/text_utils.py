...
_STOPWORDS: frozenset = frozenset(
    {
        ...
        "with", "from", "by", "about", "as",
        "just", "only", "so", "than", "very",
        # Common verbs
        "can", "make", "made", "use", "used", "say", "said",
        "get", "got", "go", "went", "come", "came",
        "take", "took", "know", "knew", "think", "thought",
        # Generic / low-value nouns
        "data", "information", "content", "post", "article", "blog",
        "website", "page", "thing", "things", "stuff", "way",
        "time", "year", "day", "week", "month",
        # Adverbs / conjunctions / prepositions
        "also", "more", "most", "some", "any", "all",
        "each", "every", "other",
        "first", "second", "third", "last",
        "new", "old", "right", "left", "good", "bad",
        "like", "such", "example", "however", "therefore", "because",
        "while", "another", "through", "during", "before", "after",
        "between", "above", "below", "even", "than", "then",
        "there", "here", "now", "today",
        "their", "shall", "within", "until", "among",
        "via", "throughout", "toward", "towards", "upon",
        "without", "against",
    }
)
