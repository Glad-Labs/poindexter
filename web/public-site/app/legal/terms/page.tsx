...
export default function TermsOfService() {
  ...
  return (
    <LegalProse>
      ...
      <p>
        Some products and subscriptions are available for purchase through{' '}
        {SITE_NAME}, including digital guides and premium prompt packs. All
        payments are processed by Lemon Squeezy (Lemon Squeezy LLC), our
        merchant of record. When you make a purchase:
      </p>
      <ul>
        <li>
