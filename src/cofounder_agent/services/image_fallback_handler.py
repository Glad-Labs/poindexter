...
class ImageFallbackHandler:
    ...
    def __init__(self):
        ...
        logger.info(f"   Pexels: {'✅ Available' if self.pexels_api_key else '⚠️  Disabled (no API key)'}")
    ...
    def _get_placeholder(
        ...
        placeholder_url = f"https://via.placeholder.com/1200x800?text={prompt[:50].replace(' ', '+')}"
