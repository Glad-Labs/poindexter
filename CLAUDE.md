...
| `template_runner.py`                      | LangGraph-backed dynamic-pipeline orchestrator (TemplateRunner). Drives the dev_diary template + future architect-composed pipelines. Postgres checkpointer wireable via `template_runner_use_postgres_checkpointer` (default off; #371 Phase 1.5).                                                                                                                |
