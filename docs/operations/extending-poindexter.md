...
| Run a background probe for health / business metrics      | **Probe**              | `plugins/probe.py::Probe`                                                  | `poindexter/brain/health_probes.py`                    |
...
graph_def (`services/canonical_blog_spec.py`, seeded into the
