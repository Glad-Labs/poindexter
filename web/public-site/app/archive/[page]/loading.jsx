    ...
    >
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8" aria-hidden="true">
        <div className="max-w-4xl mx-auto text-center animate-pulse">
          <div className="h-10 bg-[var(--gl-surface-2)] rounded w-64 mx-auto mb-4"></div>
          <div className="h-5 bg-[var(--gl-surface-2)] rounded w-80 mx-auto"></div>
        </div>
      </div>
      <div className="px-4 sm:px-6 lg:px-8 pb-20" aria-hidden="true">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-pulse">
          {Array.from({ length: 9 }).map((_, i) => (
            <div
              key={i}
              className="bg-[var(--gl-surface)]/50 border border-[var(--gl-surface-2)]/50 rounded-xl overflow-hidden"
            >
              <div className="w-full aspect-video bg-[var(--gl-surface-2)]"></div>
              <div className="p-6">
                <div className="h-5 bg-[var(--gl-surface-2)] rounded mb-3"></div>
                <div className="h-4 bg-[var(--gl-surface-2)] rounded w-5/6 mb-2"></div>
                <div className="h-4 bg-[var(--gl-surface-2)] rounded w-4/6"></div>
              </div>
            </div>
          ))}
        </div>
