...
- **End-of-Lane-B cleanup:** delete the 5 vestigial `model_router=None` ctor params at `quality_service.py:117/887/897`, `firefighter_service.py:268`, `agents/blog_quality_agent.py:31/138`. They accept any duck-typed router-like object now (the deleted `model_router` module is gone), but the param signatures are noise.
