...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-09-17)
...
- 207 live posts on gladlabs.io (381 posts total; 2,118 pipeline_tasks across all generation runs)
...
- 84,769 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
