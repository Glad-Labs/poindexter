...
| Issue | Guide | Applies To |
|-------|-------|-----------|
| 🚀 Railway Deployment Issues | [01-railway-deployment.md](./01-railway-deployment.md) | Production deployment, environment variables |
| 🔨 Build & Compilation Errors | [04-build-fixes.md](./04-build-fixes.md) | TypeScript, Node.js, npm/yarn builds |
| 📦 Module & Dependency Issues | [05-compilation.md](./05-compilation.md) | Import errors, package resolution |
