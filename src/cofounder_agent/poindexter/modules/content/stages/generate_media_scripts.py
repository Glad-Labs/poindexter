...
def _build_scene_prompt(
    ...
    *,
    ...
    return (
        ...
        "claim the article proves: the subject first, under ten words, "
        "nothing before it. \"Zero-click content is the new standard.\" NOT "
        "\"In today's digital age, zero-click content is the new standard.\" "
        "Scene-setting run-ups (\"In today's digital age\", \"In the world "
        "of\", \"These days\", \"As we all know\", \"Let's talk about\") and "
        "question cliches (\"Ever wondered\", \"Imagine\") spend the hook "
        "saying nothing. Keep every number and statistic "
