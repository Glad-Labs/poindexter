...
def image_agent(mock_clients):
    ...
    with patch('agents.image_agent.ImageGenClient', return_value=image_gen), \
...
class TestImageGeneration:
    ...
    def test_generate_images_creates_correct_number(self, image_agent, sample_blog_post, mock_clients):
    ...
    def test_generate_images_handles_failure_gracefully(self, image_agent, sample_blog_post, mock_clients):
