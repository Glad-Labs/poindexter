...
The framework itself is described in the
[declarative-data-plane RFC](/docs/architecture/declarative-data-plane-rfc-2026-04-24).
...
<Steps>
  ...
  <Step title="Seed the adapter row">
    ...
    shape from `services/migrations/20260509_175447_add_publishing_adapters.py`.
  </Step>
