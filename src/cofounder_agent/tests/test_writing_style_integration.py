...
class TestWritingStyleIntegration:
    ...
    async def test_task_create_request_without_writing_style_id(self):
        ...
        request = TaskCreateRequest(
            task_name="Test Task without Writing Style", topic="Web Development"
        )
...
class TestWritingStyleValidation:
    ...
    async def test_writing_style_id_uuid_format(self):
        ...
        request = TaskCreateRequest(
            task_name="UUID Test", topic="Testing", writing_style_id=valid_uuid
        )
    ...
    async def test_writing_style_id_optional_default_none(self):
        ...
        request = TaskCreateRequest(task_name="Optional Field Test", topic="Testing")
...
"""
        ...
        context = {"topic": "AI Testing", "writing_style_guidance": style_guidance}
