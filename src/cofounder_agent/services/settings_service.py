...
class SettingValidator:
    ...
    def validate_json(key: str, value: Any) -> bool:
        ...
        if not isinstance(value, (dict, list)):
            raise ValueError(f"Setting '{key}' must be a JSON object or array, got {type(value).__name__}")
        return True
    ...
    def validate_email_frequency(frequency: str) -> bool:
        ...
        if frequency not in valid_frequencies:
            raise ValueError(f"Invalid email frequency '{frequency}'. Must be one of: {', '.join(valid_frequencies)}")
        return True
    ...
    def validate_timezone(timezone: str) -> bool:
        ...
        valid_timezones = {
            ...
            "America/Sao_Paulo", "America/Caracas", "America/Jamaica", "America/Barbados",
            "Europe/London", "Europe/Paris", "Europe/Berlin", "Europe/Moscow", "Europe/Istanbul",
            "Europe/Athens", "Europe/Rome", "Europe/Madrid", "Europe/Dublin", "Europe/Vienna",
            "Africa/Cairo", "Africa/Johannesburg", "Africa/Lagos", "Africa/Nairobi",
            "Asia/Tokyo", "Asia/Shanghai", "Asia/Hong_Kong", "Asia/Singapore", "Asia/Bangkok",
            "Asia/Jakarta", "Asia/Manila", "Asia/Seoul", "Asia/Dubai", "Asia/Kolkata",
            "Asia/Bangalore", "Asia/Bangkok", "Australia/Sydney", "Australia/Melbourne",
        ...
        raise ValueError(f"Invalid timezone '{timezone}'. Must be a valid IANA timezone or UTC variant")
