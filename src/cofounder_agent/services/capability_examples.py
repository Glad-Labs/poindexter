...
async def generate_content_capability(
    topic: str, style: str = "professional", length: str = "medium"
) -> Dict[str, Any]:
    """
...
async def publish_capability(
    content: str, platform: str = "blog", schedule_at: Optional[str] = None
) -> Dict[str, Any]:
    """
...
def register_example_capabilities():
    ...
    logger.info("Registered %d example capabilities", len(registry.list_capabilities()))
