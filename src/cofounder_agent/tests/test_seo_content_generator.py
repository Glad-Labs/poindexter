...
class TestContentMetadataGenerator:
    ...
    def test_generate_meta_description_length(self, generator):
        ...
        descriptions = [
            generator._generate_meta_description(
                "Test Title",
                "Short content that needs a description. " * 20
            ) for _ in range(5)
        ]
    ...
    def test_calculate_reading_time(self, generator):
        ...
        for content, expected_time in test_cases:
            ...
            assert reading_time == expected_time, f"Failed for content with {len(content.split())} words, got {reading_time}, expected {expected_time}"
...
class TestSEOOptimizedContentGenerator:
    ...
    def mock_ai_generator(self):
        ...
        mock = AsyncMock()
        mock.generate_blog_post = AsyncMock(return_value=(
    ...
    def seo_generator(self, mock_ai_generator):
        ...
        from services.seo_content_generator import SEOOptimizedContentGenerator, ContentMetadataGenerator
