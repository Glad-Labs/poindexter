...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-09-11)
...
- 203 live posts on gladlabs.io (377 posts total; 2,093 pipeline_tasks across all generation runs)
...
- 87,177 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
