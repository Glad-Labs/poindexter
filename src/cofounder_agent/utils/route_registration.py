...
_WORKER_ROUTES = [
    ...
    ("routes.gates_routes", "router", "gates_router", "approval-gate admin (list / enable / pending, #1343)"),
    ("routes.posts_approval_routes", "router", "posts_approval_router", "posts-approval gate (approve / reject / pending, #1343)"),
    ...
    ("routes.activity_routes", "router", "activity_router", "console live-activity pulse — running work + recent trail (/api/activity)"),
