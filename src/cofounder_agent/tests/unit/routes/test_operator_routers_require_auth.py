...
_OPERATOR_ROUTERS: list[tuple[str, str]] = [
    ("poindexter.routes.approval_routes", "router"),
    ("poindexter.routes.task_routes", "router"),
    ("poindexter.routes.task_publishing_routes", "publishing_router"),
    ("poindexter.routes.task_status_routes", "status_router"),
    ("poindexter.routes.topics_routes", "router"),
    ("poindexter.routes.topic_batch_routes", "router"),
    ("poindexter.routes.gates_routes", "router"),
    ("poindexter.routes.posts_approval_routes", "router"),
    ("poindexter.routes.media_approval_routes", "router"),
    ("poindexter.routes.scheduling_routes", "router"),
    ("poindexter.routes.data_plane_routes", "router"),
    ("poindexter.routes.settings_routes", "router"),
    ("poindexter.routes.metrics_routes", "metrics_router"),
    ("poindexter.routes.findings_routes", "router"),
    ("poindexter.routes.seo_routes", "router"),
    ("poindexter.routes.triage_routes", "router"),
    ("poindexter.routes.module_probes_routes", "router"),
    ("poindexter.routes.pipeline_events_routes", "router"),
    ("poindexter.routes.memory_dashboard_routes", "router"),
]
