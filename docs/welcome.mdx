...
The engine is Apache 2.0. A separate **Glad Labs Pro** add-on at
[gladlabs.io/product](https://gladlabs.io/product) bundles tuned prompts,
...
<CardGroup cols={3}>
  ...
  <Card title="13-stage pipeline" icon="list-check">
    `canonical_blog` LangGraph template: write → self-review → QA →
    image-source → SEO → media scripts → finalize.
  </Card>
</CardGroup>
