...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-09-04)
...
- 200 live posts on gladlabs.io (374 posts total; 2,077 pipeline_tasks across all generation runs)
...
- 85,149 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
