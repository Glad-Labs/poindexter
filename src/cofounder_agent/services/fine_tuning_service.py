        ...
        if job["target"] == "ollama":
            ...
            try:
                ...
                return {
                    ...
                    "target": "claude",
                    "model_name": job_api.fine_tuned_model if hasattr(job_api, 'fine_tuned_model') else None
                }
            except Exception as e:
        ...
        if job["target"] == "ollama":
            ...
            try:
                ...
                if key:
                    ...
                    return {"success": True, "job_id": job_id, "status": "cancelled", "note": "Job may still be running on Claude servers"}
            except Exception as e:
