...
├─ src/cofounder_agent/tests/**init**.py
├─ src/cofounder_agent/tests/unit/**init**.py
├─ src/cofounder_agent/tests/unit/services/**init**.py
├─ src/cofounder_agent/tests/unit/routes/**init**.py
├─ src/cofounder_agent/tests/unit/agents/**init**.py
├─ src/cofounder_agent/tests/unit/models/**init**.py
└─ src/cofounder_agent/tests/utils/**init**.py
...
- tests/unit/services/test\_\*.py - Service tests (5 files)
- tests/unit/routes/test\_\*.py - Route tests (2 files)
