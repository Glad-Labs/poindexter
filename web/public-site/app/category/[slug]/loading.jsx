    ...
    <div className="min-h-screen bg-gradient-to-b from-[var(--gl-base)] via-[var(--gl-surface)] to-[var(--gl-base)] animate-pulse">
      <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="h-6 bg-[var(--gl-surface-2)] rounded w-20 mb-4"></div>
          <div className="h-10 bg-[var(--gl-surface-2)] rounded w-64 mb-4"></div>
          <div className="h-5 bg-[var(--gl-surface-2)] rounded w-96 mb-6"></div>
        </div>
      </div>
