...
class Config:
    ...
    def __init__(self):
        ...
        self.CREDENTIALS_PATH = os.path.join(self.BASE_DIR, 'content-agent', 'credentials.json')
...
if missing_vars:
    ...
    logger.critical("Please create or check your .env file in the root directory and ensure all variables are set correctly.")
