...
| Grafana            | http://localhost:3000            | 10 dashboards (Mission Control / Pipeline / Auto-Publish Gate / Cost / Observability / System Health / Integrations / **QA Rails** / **Findings** / **Revenue**)     |
...
- **Grafana (self-hosted):** http://localhost:3000 (or http://100.81.93.12:3000 from the tailnet) — 10 dashboards. Grafana Cloud was retired 2026-05-03; the local Docker container (poindexter-grafana) is the only Grafana now. Local Prometheus scrapes windows_exporter + nvidia-smi-exporter directly; Alloy was the Cloud shipper and is no longer used.
- **Dashboards:**
