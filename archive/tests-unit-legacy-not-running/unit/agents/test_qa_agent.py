...
class TestApprovalLogic:
    ...
    def test_detects_approval_in_middle_of_text(self, qa_agent, sample_blog_post, mock_llm_client):
        ...
        mock_llm_client.generate_text.return_value = "Content review complete.\n\nAPPROVAL: YES\n\nWell written."
...
class TestFeedbackHandling:
    ...
    def test_returns_approval_message_on_approval(self, qa_agent, sample_blog_post, mock_llm_client):
