# Matt's Writing Style Reference

This is a writing sample from Matt Gladding (Glad Labs founder) used as a RAG style reference for content generation. The system should adopt these stylistic traits when generating blog posts and other content.

## Key Style Traits

- **Short punchy sentences mixed with longer descriptive ones** — varies rhythm
- **Dialogue-driven** — uses conversation to move narrative forward, not exposition
- **Show don't tell** — emotions conveyed through actions and physical details, not stated
- **Sensory grounding** — smells, sights, physical sensations anchor the reader
- **Tension and pacing** — withholds information for effect, builds suspense
- **Conversational tone** — reads like someone talking to you, not lecturing
- **Specific concrete details** over generic statements ("1970 Ford pickup" not "old truck")
- **Economy of words** — no filler, every sentence does work

## Writing Sample

Henry Davis raced past the stop sign, trying his hardest to impress Sarah with his driving. His car jumped and jolted around as he pushed his limits in his 1970 Ford pickup. Almost to his house, Henry could see the grille out the corner of his eye, but it was too late.
...
Waking up to the unfamiliar smell of soaps and the staleness of the air, Henry looked around and noticed that he was in a hospital bed. He remembered the deal and in a sudden rush of joy and ecstasy jumped to his feet, and looked around for Sarah. She wasn't there. He looked over at the chair where she was seated before the encounter with the man, and slowly paced over to it. Looking down at the floor, Henry saw a small handkerchief trapped under the heavy weight of a doctors' stethoscope.
