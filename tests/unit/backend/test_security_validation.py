...
class TestCORSConfiguration:
    ...
    def test_cors_blocks_unauthorized_origins(self, client):
        ...
        response = client.get("/api/test", headers={"Origin": "http://malicious-site.com"})
...
class TestJWTSecretValidation:
    ...
    def test_jwt_secret_fallback_order(self):
        ...
        with patch.dict(
            os.environ, {"JWT_SECRET_KEY": "primary-secret", "JWT_SECRET": "fallback-secret"}
        ):
            secret = os.getenv("JWT_SECRET_KEY") or os.getenv("JWT_SECRET")
...
class TestInputValidation:
    ...
    def test_sql_injection_attempt(self, client):
        ...
        for payload in injection_payloads:
            ...
            response = client.post("/api/login", params={"username": payload, "password": "test"})
    ...
    def test_oversized_payload(self, client):
        ...
        try:
            response = client.post(
                "/api/login", params={"username": "test", "password": large_payload}
            )
    ...
    def test_missing_required_fields(self, client):
        ...
        response = client.post("/api/login", params={"username": "test"})  # Missing password
...
class TestAuthenticationEnforcement:
    ...
    def test_invalid_auth_header(self, client):
        ...
        response = client.get("/api/test", headers={"Authorization": "invalid-format"})
...
class TestSecurityIntegration:
    ...
    def test_rate_limit_with_auth(self, client):
        ...
        for i in range(3):
            response = client.post("/api/login", params={"username": "test", "password": "test"})
