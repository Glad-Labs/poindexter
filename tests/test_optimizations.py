#!/usr/bin/env python3
"""Test SDXL optimization packages - Manual test script, not a pytest test"""

# This is a standalone diagnostic script, not a pytest test file
# Run directly with: python tests/test_optimizations.py
