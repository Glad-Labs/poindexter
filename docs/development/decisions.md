...
- `docs/archive/consolidated-cleanup/decisions/WHY_FASTAPI.md` - FastAPI decision details
- `docs/archive/consolidated-cleanup/decisions/WHY_POSTGRESQL.md` - PostgreSQL decision details
- `docs/architecture/system-design.md` - System architecture
- `docs/development/workflow.md` - Process decisions
