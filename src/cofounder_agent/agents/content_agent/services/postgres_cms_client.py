...
class PostgresCMSClient:
    ...
    def __init__(self, database_url: Optional[str] = None):
        ...
        logger.info(f"PostgresCMSClient initialized (Database: {self._mask_url(self.database_url)})")
        ...
        try:
            ...
            async with self.pool.acquire() as conn:
                ...
                """, 
                    ...
                    slug,
                    content,
                    post.meta_description or (content[:200] + "..." if len(content) > 200 else content),
    ...
    async def upload_image_metadata(self, image_details: ImageDetails, post_id: Optional[str] = None) -> Optional[str]:
        """
