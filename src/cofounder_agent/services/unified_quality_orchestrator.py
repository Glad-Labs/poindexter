...
class UnifiedQualityOrchestrator:
    ...
    async def evaluate_content(
        ...
        logger.info(
            f"Starting unified evaluation: "
            f"pattern={use_pattern_eval}, qa={use_qa_agent}"
        )
        ...
        try:
            ...
            if use_qa_agent:
                ...
                try:
                    ...
                    logger.warning(f"QA Agent evaluation failed: {e}. Continuing with pattern only.")
                    qa_result = None
            ...
            if pattern_result and qa_result:
                ...
                logger.info(f"Hybrid score: {hybrid_result.hybrid_overall}/10 "
                ...
                if store_result:
                    ...
                    try:
                        ...
                        stored_result = await self.persistence.create_quality_score(
                            content_id=None,  # Could be post ID if available
                            **quality_score_dict
                        )
                        results["stored"] = {
