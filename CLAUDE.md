...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-09-06)
...
- 200 live posts on gladlabs.io (374 posts total; 2,080 pipeline_tasks across all generation runs)
...
- 86,038 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
