  ...
  return (
    <>
      ...
      <p>
        ...
        data. We keep it straightforward because privacy policies shouldn&apos;t
      ...
      <p>
        The following services are only activated if you explicitly consent via
        our cookie banner:
      </p>
      <ul>
        <li>
      ...
      <ul>
        <li>Understand which content performs well (first-party analytics)</li>
      ...
      <ul>
        ...
        <li>
          <strong>Sentry Error Data:</strong> Error reports are retained for 90
          days.
        </li>
        <li>
        ...
        <li>
          <strong>Cookie Preferences:</strong> Stored in your browser until you
          clear them.
        </li>
        <li>
      ...
      <p>
        ...
        (or 16 in the EU). If we learn we&apos;ve collected data from a child
        under these ages, we&apos;ll delete it promptly. Parents: if you
