        ...
        if stored_seo and stored_seo.get("seo_description"):
            ...
            try:
                ...
                if seo_desc:
                    ...
                    result["seo_description"] = f"Read about {title.lower()}. Discover insights and expert guidance."
            except Exception as e:
...
Generate ONLY comma-separated keywords, nothing else. Example format: keyword1, keyword2, keyword3"""
    ...
    def _keyword_match_category(
        ...
        return best_category or (available_categories[0] if available_categories else None), best_score
