    ...
    async def _sync_execution(self, initial_state: ContentPipelineState) -> dict:
        ...
        try:
            ...
            return {
                ...
                "content_preview": (result["final_content"][:500] + "...") if result["final_content"] else "No content generated"
            }
        ...
        try:
            ...
            async for event in self.content_graph.astream(initial_state):
                ...
                yield {
                    ...
                    "current_content_preview": state.get("draft", "")[:300] if state.get("draft") else ""
                }
