...
class CostTrackingService:
    ...
    async def fetch_cost_metrics(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(
                "Unexpected error fetching cost metrics",
                error=str(e)
            )
            return None
    ...
    async def analyze_costs(self) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            'optimization_performance': {
                ...
                'model_router_savings': model_router.get('estimated_savings_usd', 0) if model_router else 0,
                'budget_model_usage': model_router.get('budget_model_percentage', 0) if model_router else 0,
