...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-09-13)
...
- 203 live posts on gladlabs.io (377 posts total; 2,095 pipeline_tasks across all generation runs)
- 495 Python files under `src/cofounder_agent/poindexter/services/` (~291 substantive after `__init__.py` stubs)
...
- 86,363 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
