...
# ---------------------------------------------------------------------------
# POST /api/track/view — DELETED 2026-05-28
#
# The track_page_view endpoint was deleted along with the Vercel proxy at
# web/public-site/app/api/page-views/route.ts. The path had been silent
# since 2026-04-09 because Vercel serverless functions can't reach the
# operator's local Docker network. Replacement is a Cloudflare Worker
# beacon (infrastructure/cloudflare/page-views-beacon/) + the
# sync_cloudflare_analytics job that pulls aggregated rows into the
# page_views table via the CF AE SQL HTTP API.
# ---------------------------------------------------------------------------
