...
- Create blog posts through an intuitive form UI
- Run content through the existing AI pipeline
- Generate SEO metadata, featured images, and blog content
- Save output directly to PostgreSQL for Strapi integration
- Track generation progress via task polling
...
2. ✅ All models displayed in selector
...
```
web/oversight-hub/src/components/pages/ContentManagementPage.jsx
src/cofounder_agent/routes/chat_routes.py
```
