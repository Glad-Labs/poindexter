...
2. **Set up your development environment:**
   - See [Environment Variables](../operations/env-vars.md)
...
4. **Contribute to development:**
   - Check [Development Workflow](../development/workflow.md)
   - Review [Multi-Agent Pipeline](./multi-agent-pipeline.md)
...
- **[Development Workflow](../development/workflow.md)** - Git and testing
