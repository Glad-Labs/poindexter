    ...
    def run_job(self):
        ...
        for post in tasks:
            ...
            try:
                ...
                # --- Stage 1: Content Generation & Refinement Loop ---
                approved = False
                ...
                self.sheets_client.update_status_by_row(post.sheet_row_index, final_status, post.strapi_url)
                self.firestore_client.update_task_status(doc_id, final_status)
