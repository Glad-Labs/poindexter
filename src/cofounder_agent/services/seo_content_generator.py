...
Create an image that would work well for social media sharing and blog display."""
    ...
    def generate_social_metadata(self, title: str, excerpt: str, image_url: Optional[str] = None) -> Dict[str, str]:
...
class SEOOptimizedContentGenerator:
    ...
    def __init__(self, ai_content_generator, metadata_generator: Optional[ContentMetadataGenerator] = None):
