...
class TestBulkTaskRoutes:
    ...
    def test_bulk_create_tasks(self, client, auth_headers):
        ...
        response = client.post("/api/tasks/bulk/create", json=bulk_data, headers=auth_headers)
    ...
    def test_bulk_create_empty_list(self, client, auth_headers):
        ...
        response = client.post("/api/tasks/bulk/create", json={"tasks": []}, headers=auth_headers)
    ...
    def test_bulk_update_tasks(self, client, auth_headers):
        ...
        response = client.post("/api/tasks/bulk/update", json=update_data, headers=auth_headers)
    ...
    def test_bulk_delete_tasks(self, client, auth_headers):
        ...
        delete_data = {"task_ids": ["test_id_1", "test_id_2", "test_id_3"]}

        response = client.delete("/api/tasks/bulk/delete", json=delete_data, headers=auth_headers)
    ...
    def test_bulk_delete_empty_list(self, client, auth_headers):
        ...
        response = client.delete(
            "/api/tasks/bulk/delete", json={"task_ids": []}, headers=auth_headers
        )
    ...
    def test_bulk_operations_invalid_json(self, client, auth_headers):
        ...
        response = client.post("/api/tasks/bulk/create", data="invalid json", headers=auth_headers)
    ...
    def test_bulk_operations_missing_fields(self, client, auth_headers):
        ...
        response = client.post("/api/tasks/bulk/create", json=incomplete_data, headers=auth_headers)
...
class TestBulkTaskPerformance:
    ...
    def test_large_bulk_create_limit(self, client, auth_headers):
        ...
        response = client.post("/api/tasks/bulk/create", json=large_bulk, headers=auth_headers)
