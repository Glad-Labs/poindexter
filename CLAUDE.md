...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-08-10)
...
- 175 live posts on gladlabs.io (349 posts total; 2,027 pipeline_tasks across all generation runs)
...
- 65,883 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
