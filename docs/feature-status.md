...
| RSS Feed             | WORKING            | Blog feed.xml + JSON Feed 1.1. Feed dedup via `distributed_at` + cutoff date. Direct Bluesky + Mastodon adapters replaced dlvr.it for those networks (GH-36); dlvr.it is still used for X/Twitter cross-posting. |
