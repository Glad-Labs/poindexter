...
* **grafana:** consolidate 14 dashboards → 6 (Mission Control + 5 grouped) ([a49681e](https://github.com/Glad-Labs/poindexter/commit/a49681e828f5bbcc3ac0ca93fccfee52d345cf71))
...
* **image:** add FLUX.1-schnell ImageProvider plugin ([02f9149](https://github.com/Glad-Labs/poindexter/commit/02f914999b8d2792f2a65343c4436374b3fe4eae))
...
* **llm:** AnthropicProvider plugin (Claude family) ([51a877b](https://github.com/Glad-Labs/poindexter/commit/51a877bd335203487245220cbc8029a643d53679))
* **llm:** GeminiProvider plugin (Google AI Studio) ([ddd1f51](https://github.com/Glad-Labs/poindexter/commit/ddd1f51006f75bfd055be2c2da7f1b65bc6f6085))
...
* **llm:** OpenAICompatProvider plugin (vLLM, llama.cpp, LocalAI, OpenRouter, OpenAI) ([70b0ca5](https://github.com/Glad-Labs/poindexter/commit/70b0ca599f04750143f8d04119e4d85e68574623))
...
* **monitoring:** retire 15 Grafana alerts, add brain gpu_temperature probe ([a268c28](https://github.com/Glad-Labs/poindexter/commit/a268c28963a3f4c7814dc11c15617850f3c6e375))
...
* **observability:** wire OTel tracing → Tempo + quiet sentry-sdk debug noise ([0164635](https://github.com/Glad-Labs/poindexter/commit/0164635b4a0a62b41df36808ae375a74dac00abe))
...
* **observability:** wire Tempo dashboard end-to-end ([927bec3](https://github.com/Glad-Labs/poindexter/commit/927bec380521ac03d91d7e1a74c984c5e919ea07))
...
* **pipeline:** declarative qa_gates table ([8450920](https://github.com/Glad-Labs/poindexter/commit/84509201eb4c45c101b9e0589acda564474290aa))
...
* **podcast:** add TTSProvider plugin contract + Kokoro-82M implementation ([134d0ac](https://github.com/Glad-Labs/poindexter/commit/134d0accd5d85a98237682a616b36c86f240dd89))
...
* **prompt-manager:** Pro-tier prompt gating (gitea[#225](https://github.com/Glad-Labs/poindexter/issues/225)) ([cbdb331](https://github.com/Glad-Labs/poindexter/commit/cbdb33125726d4b132b8428ccc35b2015b9cf801))
...
* **scripts:** backfill_awaiting_images.py — recover featured images for missed tasks ([ab72ceb](https://github.com/Glad-Labs/poindexter/commit/ab72ceb8144285fb1b968eba6ba53f0fb129b83b))
...
* **storage:** declarative object_stores table ([92e276e](https://github.com/Glad-Labs/poindexter/commit/92e276ea4b467e627b29f5dec31810cc14d11d44))
...
* **video:** add VideoProvider plugin contract + Wan 2.1 T2V 1.3B implementation ([23cddf3](https://github.com/Glad-Labs/poindexter/commit/23cddf3df614089d8b1a9bd4ac8683a9153bfbed))
...
* **brain:** make approval_queue alert threshold tunable (was hardcoded 5) ([282d065](https://github.com/Glad-Labs/poindexter/commit/282d0659088c0ed8ef8cc3bda3a6b4f9abe3fb9b))
...
* **brain:** probe_topic_quality uses correct audit_log columns ([bf5f5a8](https://github.com/Glad-Labs/poindexter/commit/bf5f5a855cca2e059cfc3d414f60c76cd78b4b67))
...
* **brain:** set descriptive User-Agent on every outbound probe ([e6f1183](https://github.com/Glad-Labs/poindexter/commit/e6f1183618fc085054dd7a01915b5c1be5a15872))
...
* **content_db:** cast post_tags.tag_id to uuid[], not text[] ([56163e3](https://github.com/Glad-Labs/poindexter/commit/56163e3880591e5654fae5623ed3e46345c710e6))
* **content:** fail loud instead of serving template content when model chain exhausts ([3d1a603](https://github.com/Glad-Labs/poindexter/commit/3d1a6035e1538de536d39beb6277e12e98612dac))
...
* **database_service:** local-pool sizing reads env vars, not the removed singleton (gitea[#279](https://github.com/Glad-Labs/poindexter/issues/279) follow-up via PR[#281](https://github.com/Glad-Labs/poindexter/issues/281)) ([2a19e5a](https://github.com/Glad-Labs/poindexter/commit/2a19e5af1a0b53e842366dc46a1da98a44b7f1c3))
...
* **deps:** pyroscope-io 1.0.6 + drop the dead `profiling` extras alias ([f098f13](https://github.com/Glad-Labs/poindexter/commit/f098f137547df14835dee4eeff2f8b2371aa377b))
...
* **grafana:** mission-control drilldown links + chart variety ([37d25cb](https://github.com/Glad-Labs/poindexter/commit/37d25cb51a5f90671e4d4a0f3202e9d22cfa0f3a))
...
* **mcp:** raise on non-2xx in _api instead of returning fake-success dict ([0a4af94](https://github.com/Glad-Labs/poindexter/commit/0a4af94eba9911cf6f9cdd4dd93255da094f3e21))
...
* **observability:** pyroscope-io as core dep, drop dead OpenAI instrumentor, fix brain probe attribution ([68563f4](https://github.com/Glad-Labs/poindexter/commit/68563f45f4f47b727a2ed615db7475ec4938a1d8))
* **observability:** strip ANSI + ISO timestamp from Sentry events to fix fingerprinting ([68914fa](https://github.com/Glad-Labs/poindexter/commit/68914fa3136447aa0256aa29438c7e2978c5e80d))
...
* **public-site/product:** strip $29 SKU + update Pro variant to current LS product ([140c43c](https://github.com/Glad-Labs/poindexter/commit/140c43c1db98121eaa278f9e65393c4e1b256734))
...
* **publish:** drop bogus ::uuid cast in _finalize_publish UPDATE ([24a2e75](https://github.com/Glad-Labs/poindexter/commit/24a2e75f441a96410425f2b7e51d1a43b26137ea))
* **publish:** finalize content_tasks status and revalidate Next.js cache ([4f11d32](https://github.com/Glad-Labs/poindexter/commit/4f11d3200dee180a77fb9fbe7295a1f9b673a1a1))
* **publish:** root-cause UndefinedColumnError in publish_service ([120686c](https://github.com/Glad-Labs/poindexter/commit/120686c1d7e7437af69bc4a2cb575b097de445eb))
...
* **scripts:** add UTF-8 BOM + ASCII-clean claude-sessions.ps1, broaden doc-sync to nightly ([752c237](https://github.com/Glad-Labs/poindexter/commit/752c2372d8bd52e3531d415c589ece70df861c9f))
...
* **social:** drop Telegram leg from _notify, Discord only ([bf7b16c](https://github.com/Glad-Labs/poindexter/commit/bf7b16c418e908273cdb40ff1b203ab7c22576c2))
...
* **telemetry:** respect _initialized latch in setup_telemetry ([d34aea9](https://github.com/Glad-Labs/poindexter/commit/d34aea94de5e99a84a6a5acf5376b165a818a124))
* **telemetry:** switch OTLP exporter to gRPC + workaround FastAPI middleware-stack lock ([3f62697](https://github.com/Glad-Labs/poindexter/commit/3f6269792a9b73c6dccf2ac1b401c946d2c4ed23))
...
* **tests:** teach fake Singer tap to handle --discover mode ([3e5f6c3](https://github.com/Glad-Labs/poindexter/commit/3e5f6c3301649f546d48854204e1eebe36cbd218))
...
* **voice-bot:** decrypt is_secret app_settings before login (GH-107 pattern) ([fe7567b](https://github.com/Glad-Labs/poindexter/commit/fe7567be51c9ab588ebbd659796a6cd03a9102f0))
...
* **worker:** stall detector measures pending-queue dwell time, not wall-clock ([6e5529e](https://github.com/Glad-Labs/poindexter/commit/6e5529e09998158511297fbf761ddbc5c4f405ea))
