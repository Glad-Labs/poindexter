...
1. **docs/05-AI_AGENTS_AND_INTEGRATION.md** (if agent-related)
   - Document agent type/capability
   - List files involved
   - Describe workflow/flow
   - Add examples

2. **docs/02-ARCHITECTURE_AND_DESIGN.md** (if architectural change)
...
grep -l "Last Updated" .github/copilot-instructions.md CLAUDE.md docs/TECHNICAL_DEBT_TRACKER.md
...
- **Architecture questions:** Check docs/02-ARCHITECTURE_AND_DESIGN.md
- **Deployment questions:** Check docs/03-DEPLOYMENT_AND_INFRASTRUCTURE.md
- **Specific issue status:** Check docs/TECHNICAL_DEBT_TRACKER.md
...
- **Issue Tracking:** [docs/TECHNICAL_DEBT_TRACKER.md](TECHNICAL_DEBT_TRACKER.md)
- **Architecture Guide:** [docs/02-ARCHITECTURE_AND_DESIGN.md](02-ARCHITECTURE_AND_DESIGN.md)
- **Development Workflow:** [docs/04-DEVELOPMENT_WORKFLOW.md](04-DEVELOPMENT_WORKFLOW.md)
