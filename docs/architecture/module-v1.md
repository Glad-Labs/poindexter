...
An audit of `src/cofounder_agent/poindexter/plugins/` on 2026-05-13 found:
...
- `src/cofounder_agent/poindexter/plugins/registry.py` — existing entry-point
  discovery, basis for Component 1.
- `src/cofounder_agent/poindexter/plugins/{tap,stage,probe,job,...}.py` —
  existing plugin Protocols that modules will bundle.
- `src/cofounder_agent/poindexter/services/migrations/__init__.py` — runner
