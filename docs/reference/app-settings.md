...
> **Auto-generated from live `app_settings` table on 2026-08-16.**  
...
| `video_slideshow_prompt_model` | `ollama/llama3:latest` |  | Per-call-site backstop for services.video_service image prompt-gen. Deliberately non-thinking — qwen3/glm-4 thinking ... |
