...
MEDIA_PIPELINE_GRAPH_DEF: dict[str, Any] = {
    "name": "media_pipeline",
    "description": (
        "Stage-2 media pipeline (Plan 6, #689/#675/#676/#1193): load persisted "
        "Stage-1 scripts/shot-lists, run one ASR pass to caption the narration "
        "(and fidelity-check the transcript vs the script), render the 16:9 "
        "long-form and 9:16 short-form videos with captions burned in, then "
        "QA the rendered videos (A/V duration sync, caption presence, gated "
        "frame human-detection). Gate/distribute nodes added in Plans 7-8."
    ),
    "entry": "load_scripts",
    "nodes": [
