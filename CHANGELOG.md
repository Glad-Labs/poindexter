...
* **checkout:** Lemon Squeezy overlay — in-page checkout instead of redirect ([5b3e53b](https://github.com/Glad-Labs/poindexter/commit/5b3e53b5fa982541b4271e501f3dbda337756d41))
...
* **config:** wire site_config reload — POST /api/settings/reload + every-1m job (closes gitea[#280](https://github.com/Glad-Labs/poindexter/issues/280)) ([2936db5](https://github.com/Glad-Labs/poindexter/commit/2936db57c2c00b9f2b54e24ad0330c6f157e8d19))
...
* **lint:** reject new os.getenv in services/ via pre-commit hook — GH[#93](https://github.com/Glad-Labs/poindexter/issues/93) Phase 3 ([b9809f7](https://github.com/Glad-Labs/poindexter/commit/b9809f78cddf6e7247e8486fc9c96449b05f0b5e))
...
* **metrics:** port 15 legacy /api/prometheus metrics to prometheus_client (Gitea [#269](https://github.com/Glad-Labs/poindexter/issues/269)) ([e0e6480](https://github.com/Glad-Labs/poindexter/commit/e0e648043cbb5d222c12fa161482a17432fe2ff1))
...
* **phase-1:** wire add_review + add_distribution + backfill so content_tasks view stops lying ([9e63617](https://github.com/Glad-Labs/poindexter/commit/9e63617b22cb26d0b865c8cdb3d0eaeb3e80a9bf))
* **phase-2:** close the silent-drop taxonomy (gitea[#267](https://github.com/Glad-Labs/poindexter/issues/267), [#268](https://github.com/Glad-Labs/poindexter/issues/268), [#270](https://github.com/Glad-Labs/poindexter/issues/270), trigger audit, dead table) ([540831b](https://github.com/Glad-Labs/poindexter/commit/540831bd5e7c63d84870c811b0bda4e55d7f5441))
* **phase-3:** turn on the feedback loops — model_performance, content_revisions, gpu_task_sessions, routing_outcomes, external webhooks ([b490c99](https://github.com/Glad-Labs/poindexter/commit/b490c99bc6d3f51920803af7d84799b935c9e52e))
* **phase-4:** retention janitor + dead-table drop — cleanup pass (gitea[#271](https://github.com/Glad-Labs/poindexter/issues/271)) ([b49ee53](https://github.com/Glad-Labs/poindexter/commit/b49ee533e2e059fb625f0f5cde45493237c964a0))
* **phase-6:** source-verified citation pipeline (GH[#54](https://github.com/Glad-Labs/poindexter/issues/54) / gitea[#271](https://github.com/Glad-Labs/poindexter/issues/271)) ([821e261](https://github.com/Glad-Labs/poindexter/commit/821e261006ff395528ad73a47b8067bb6b121b0e))
...
* **post_performance:** page_views→post_performance aggregator (local half of gitea[#272](https://github.com/Glad-Labs/poindexter/issues/272)) ([ef7c2dd](https://github.com/Glad-Labs/poindexter/commit/ef7c2ddffa610db38b54679e7153d1c568decd84))
...
* **public-site:** migrate /product marketing page to E3 ([d086cc8](https://github.com/Glad-Labs/poindexter/commit/d086cc8cd56df5484aef01b8c1bf01e7aea537e6))
* **public-site:** migrate archive page to E3 brand (GL pilot) ([968fc96](https://github.com/Glad-Labs/poindexter/commit/968fc963fa1fe0d4ee6a43ac6c1f13101402c72b))
* **public-site:** migrate cookie banner + finish home page E3 rollout ([464d611](https://github.com/Glad-Labs/poindexter/commit/464d611b55fcd28f22fde4cdc92180202cca7d6d))
* **public-site:** migrate Footer + NewsletterModal to E3 ([efdfaf7](https://github.com/Glad-Labs/poindexter/commit/efdfaf76c2ccbc8344b9e1e1fc004d593720b67d))
* **public-site:** migrate legal + error + 404 + preview pages to E3 ([d37a536](https://github.com/Glad-Labs/poindexter/commit/d37a5369528c1bf08755171d08ed9ddcb7f62eff))
* **public-site:** migrate remaining 8 pages to E3 brand + add brand types ([557802a](https://github.com/Glad-Labs/poindexter/commit/557802aac80ba4d3bf27183fbbb7bf1311ec405d))
...
* **testing:** real-Postgres integration test harness (GH[#21](https://github.com/Glad-Labs/poindexter/issues/21)) ([772811f](https://github.com/Glad-Labs/poindexter/commit/772811f2dad5fc8d4b9302e5a181db4c29413a5f))
* **topic_discovery:** issue-derived topics via codebase pgvector source (Matt 2026-04-22) ([909e3ab](https://github.com/Glad-Labs/poindexter/commit/909e3abb1ce3be1dcc5c52637b22bbe267a30838))
...
* **brand + nav:** responsive Display hero + mobile hamburger menu ([5a871b5](https://github.com/Glad-Labs/poindexter/commit/5a871b51be703936044101f2f134064f5068e12c))
...
* **budget:** exclude electricity + ollama from monthly spend cap seed ([9a63af5](https://github.com/Glad-Labs/poindexter/commit/9a63af5620e371f619af5860108eda53650691cf))
...
* **ci:** repair Gitea Security workflow — trivy install + sbom artifact upload ([291f293](https://github.com/Glad-Labs/poindexter/commit/291f293be29b1296c90f8f56358bbc739b231724))
* **ci:** repair Security workflow — swap gitleaks-action→CLI + bump Trivy pin (closes gitea[#275](https://github.com/Glad-Labs/poindexter/issues/275), gitea[#276](https://github.com/Glad-Labs/poindexter/issues/276)) ([111241a](https://github.com/Glad-Labs/poindexter/commit/111241ae0da8459ec86d4f1b370e68a720239093))
...
* **cross_model_qa:** flip model_performance.human_approved=False on QA rejection ([915702b](https://github.com/Glad-Labs/poindexter/commit/915702b266330490bd38dc6f8847016c7fe1eb56))
* **cross_model_qa:** write pipeline_reviews on QA rejection ([80f2f4d](https://github.com/Glad-Labs/poindexter/commit/80f2f4dee54d55f5faabb76ef19b348dd43575a7))
...
* **deps:** bump pytest-asyncio to 1.x — unblocks integration_db conftest + pytest 9 ([03653d9](https://github.com/Glad-Labs/poindexter/commit/03653d9488c2b1a1ace93e7ac7375005822efa8b))
* **deps:** regenerate poetry.lock — Gitea test-backend blocked on drifted hash ([bc85e6e](https://github.com/Glad-Labs/poindexter/commit/bc85e6eb6b9f8ba7a5f385f124eaa7d1d1c94e4e))
...
* **frontend:** search matches post tags[] + backfill legacy ||provider|| tokens ([502b6dd](https://github.com/Glad-Labs/poindexter/commit/502b6dd83649e8c4900361d816bd5fc460604679))
* **giscus:** point at Glad-Labs/poindexter, not the nonexistent glad-labs-codebase ([31f8681](https://github.com/Glad-Labs/poindexter/commit/31f8681bed4c8e901900798092f1831f0e0c1111))
* **giscus:** remove hardcoded defaults — Vercel env vars are now the only source ([fb7b201](https://github.com/Glad-Labs/poindexter/commit/fb7b201b76350ba6652bb0d18f9cbf99fbe7b10f))
...
* **grafana+tests:** dedupe stale series in pipeline stat panel, skip memory integration tests when DSN is conftest sentinel ([51e465e](https://github.com/Glad-Labs/poindexter/commit/51e465ec521026bb7ad6a8469bafbd4f37675ac9))
...
* **jobs:** disable SyncSharedContextJob — script doesn't exist ([184dd82](https://github.com/Glad-Labs/poindexter/commit/184dd82d46a838ad5b19b0a5edebeb72a0cb24e1))
...
* **observability:** exclude 'system' model from model_performance mirror ([d08cfad](https://github.com/Glad-Labs/poindexter/commit/d08cfadb417b7c227c3d8c9144cf3858bfcf6480))
* **observability:** extend 'system' filter to routing_outcomes too ([6e7844e](https://github.com/Glad-Labs/poindexter/commit/6e7844e2d249e68d13e2d5f7045f8d77ccc32d45))
...
* **pipeline:** filter non-column keys out of update_task() before UPDATE ([010b6ae](https://github.com/Glad-Labs/poindexter/commit/010b6aecac3d12ed7681bf8ac274d386737f0b35))
* **pipeline:** finalize_task passes title to generate_excerpt — unblocks the approval queue ([e475428](https://github.com/Glad-Labs/poindexter/commit/e4754285920714c5a1c5864db1ade60d57bd3ec2))
...
* **pipeline:** parents[3] path lookups crash in worker container (/app only has 3 levels) ([de38910](https://github.com/Glad-Labs/poindexter/commit/de38910022fe664130f25411f1aeb12f4894188a))
...
* **pipeline:** propagate started_at through content_tasks UPDATE trigger + fix misleading rejection log ([739a61e](https://github.com/Glad-Labs/poindexter/commit/739a61eef52b6b21bc9870b82db432079a1b628e))
* **pipeline:** topic_discovery manual_trigger bypasses cooldown (closes gitea[#277](https://github.com/Glad-Labs/poindexter/issues/277)) ([e13584b](https://github.com/Glad-Labs/poindexter/commit/e13584b6d8bff12ff4523a1a7dda57ac83899fba))
...
* **public-site:** /search proxies through /api/posts instead of hitting R2 ([6931f25](https://github.com/Glad-Labs/poindexter/commit/6931f2515bfa574130807bca5f0b86d87408778d))
* **public-site:** add md/lg padding to hero + article sections ([905fa66](https://github.com/Glad-Labs/poindexter/commit/905fa6634421375ba720e815ef160710927cca69))
* **public-site:** CSP gaps — unblock /search + CF Insights + LS affiliate ([0706a10](https://github.com/Glad-Labs/poindexter/commit/0706a105cf6385a0acd0bcb2c33197ab164f66c7))
* **public-site:** mirror STATIC_URL fallback into CSP connect-src ([f738433](https://github.com/Glad-Labs/poindexter/commit/f738433ce5959fdc3b8197c26c839ff305501f4b))
* **public-site:** normalize padding across all outer wrappers ([a305dc8](https://github.com/Glad-Labs/poindexter/commit/a305dc88fdaf792de158c1f166787506a6fcc94f))
* **public-site:** stop forcing uppercase on every &lt;h1&gt; ([14d0096](https://github.com/Glad-Labs/poindexter/commit/14d0096300a62462d9866884b8474359d116044b))
...
* **qa:** persist quality_score on rejected tasks — Grafana was blind to reject severity ([f506d72](https://github.com/Glad-Labs/poindexter/commit/f506d72d5b6734309476777bc481934eacaf256b))
...
* **research_context:** repair silent signature mismatch against InternalLinkCoherenceFilter ([76003fa](https://github.com/Glad-Labs/poindexter/commit/76003fa4e83e5172df6208bd1d5a5dfa1689187b))
...
* **routes:** break circular import in task_publishing_routes — unblocks 8 integration tests ([88f6556](https://github.com/Glad-Labs/poindexter/commit/88f655636dbeec04498c09e2167af417d1140904))
* **scripts/sync-to-github:** force-checkout main so the runbook doesn't strand the repo on the temp branch ([5cfe19d](https://github.com/Glad-Labs/poindexter/commit/5cfe19d7ce859e2e9665b1e09a024d9f0ce3ecd1))
...
* **security:** restore mattg@ in gitleaks baseline — scrubbing broke findingsEqual match ([10c6f23](https://github.com/Glad-Labs/poindexter/commit/10c6f23264e40a8ca9c9d9c53f16eb5693d66822))
...
* **task_executor:** write pipeline_reviews + model_performance outcome on semantic_dedup rejection ([65c4498](https://github.com/Glad-Labs/poindexter/commit/65c4498be342146c0561a927fee50f4025a3fde1))
...
* **tasks_db:** guard update_task() reroute against None task_metadata ([26b0347](https://github.com/Glad-Labs/poindexter/commit/26b03470eb4fafa171ed3ecd5330957a02f28ccd))
...
* **topic_discovery:** dedup no longer counts rejected drafts as "covered" (Matt 2026-04-22) ([ea7c967](https://github.com/Glad-Labs/poindexter/commit/ea7c967775fa50051e4737407f0776d311e7d616))
...
* **webhooks:** wrap get_database_dependency in Depends() ([326a97d](https://github.com/Glad-Labs/poindexter/commit/326a97d531f0927273cf3bd4b6a7c4e1a4d1f85b))
...
* **worker:** mount brain/ + add to PYTHONPATH so config/__init__.py import works in container ([d501e1f](https://github.com/Glad-Labs/poindexter/commit/d501e1f2414cae67176aa6c7896e63d7fc54dafd))
