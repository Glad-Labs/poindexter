...
class AnthropicAdapter(ProviderAdapter):
    ...
    async def generate(
        ...
        **kwargs
        ...
        if not self.client:
            raise Exception("Anthropic client not configured. Set ANTHROPIC_API_KEY environment variable.")
...
class OpenAIAdapter(ProviderAdapter):
    ...
    async def generate(
        ...
        **kwargs
        ...
        if not self.client:
            raise Exception("OpenAI client not configured. Set OPENAI_API_KEY environment variable.")
...
class ModelConsolidationService:
    ...
    def _initialize_adapters(self):
        ...
        for provider_type, adapter_class in adapters_to_init:
            try:
                ...
                logger.warning("Failed to initialize adapter", provider=provider_type.value, error=str(e))
    ...
    def list_models(self, provider: Optional[ProviderType] = None) -> Dict[str, List[str]]:
        ...
        return {
            provider.value: adapter.list_models()
