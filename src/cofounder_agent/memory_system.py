        ...
        try:
            ...
            async with self.db_pool.acquire() as conn:
                ...
                """,
                    ...
                    (
                        memory.related_memories if memory.related_memories else None
                    ),  # Pass list directly
    ...
    async def store_conversation_turn(
        ...
        if len(content) > 50:  # Only store substantial messages
            ...
            if any(
                ...
                for keyword in ["strategy", "goal", "important", "priority", "plan", "decision"]
            ):
            ...
            async with self.db_pool.acquire() as conn:
                ...
                if outdated_rows:
                    ...
                    self.recent_memories = [
                        m for m in self.recent_memories if m.id not in memory_ids
                    ]
