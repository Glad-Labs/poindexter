...
_BRAIN_REQUIRED_MODULES: tuple[tuple[str, str, str], ...] = (
    ...
    ("_HAS_SIDECAR_RAM_WATCH", "poindexter/brain/sidecar_ram_watch.py",
     ...
     "2026-08-27"),
    ("_HAS_OLLAMA_RUNNER_RAM_WATCH", "poindexter/brain/ollama_runner_ram_watch.py",
    ...
    ("_HAS_DOCKER_PORT_FORWARD_PROBE", "poindexter/brain/docker_port_forward_probe.py",
     "Windows wslrelay stuck-state auto-recovery offline (#222)"),
    ("_HAS_DATA_FRESHNESS_PROBE", "poindexter/brain/data_freshness_probe.py",
     "Data-feed dead-man's switch offline — dashboards can serve stale data "
     "silently (incl. the iCUE corsair_csv sensor feed, #868)"),
    ("_HAS_SCHEDULED_WORKFLOW_WATCH", "poindexter/brain/scheduled_workflow_watch.py",
    ...
    ("_HAS_CLOCK_SKEW_PROBE", "poindexter/brain/clock_skew_probe.py",
    ...
    ("_HAS_DEPLOY_SYNC_PROBE", "poindexter/brain/deploy_sync_probe.py",
     "Deploy-path dead-man's switch offline — a frozen deploy-sync timer "
     "leaves merged main undeployed with no signal (#977)"),
    ("_HAS_PR_STALENESS_PROBE", "poindexter/brain/pr_staleness_probe.py",
     "Stale PR detection offline — agent PRs sit unmerged forever"),
    ("_HAS_DISCORD_BOT_PROBE", "poindexter/brain/discord_bot_probe.py",
    ...
    ("_HAS_BRANCH_DRIFT_PROBE", "poindexter/brain/branch_drift_probe.py",
     "Branch-drift deploy canary offline — prod checkout falling behind origin/main goes undetected (#942)"),
    ("_HAS_POST_PERFORMANCE_PROBE", "poindexter/brain/post_performance_probe.py",
     "Post-performance signal detection offline — broken/fading posts go undetected (#520/#672)"),
    ("_HAS_SERVICE_RESTART", "poindexter/brain/service_restart.py",
