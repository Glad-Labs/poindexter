...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-08-19)
...
- 184 live posts on gladlabs.io (358 posts total; 2,044 pipeline_tasks across all generation runs)
...
- 71,295 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
