...
class NLPIntentRecognizer:
    ...
    async def extract_topic(self, message: str, context: Dict[str, Any]) -> Dict[str, Optional[str]]:
    ...
    async def extract_platforms(self, message: str, context: Dict[str, Any]) -> Dict[str, list]:
        ...
        return {"platforms": found_platforms or ["twitter", "linkedin"]}  # Default to Twitter and LinkedIn
    ...
    async def extract_content_to_check(self, message: str, context: Dict[str, Any]) -> Dict[str, str]:
    ...
    async def extract_metrics(self, message: str, context: Dict[str, Any]) -> Dict[str, list]:
        ...
        """
        all_metrics = [
            "views", "engagement", "shares", "clicks",
            "conversions", "roi", "ctr", "conversion_rate",
        ]
