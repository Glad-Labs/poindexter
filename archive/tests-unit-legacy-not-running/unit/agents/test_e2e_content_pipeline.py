...
def mock_all_services():
    ...
    with patch('orchestrator.FirestoreClient') as mock_firestore, \
        ...
        mock_strapi_instance.create_post.return_value = ("post-123", "https://strapi.example.com/post-123")
        mock_gcs_instance.upload_file.return_value = "https://storage.example.com/image.jpg"
        mock_pexels_instance.search.return_value = [{"src": {"large": "https://example.com/img.jpg"}, "alt": "test"}]
    ...
    def test_research_to_creative_flow(self, mock_all_services):
        ...
        with patch('orchestrator.load_prompts_from_file', return_value={}):
            ...
            with patch('agents.research_agent.requests.post') as mock_post:
                research_data = {
                    "organic": [
                        {"title": "AI in Healthcare", "link": "https://example.com", "snippet": "AI is revolutionizing healthcare"}
                    ]
                }
    ...
    def test_image_to_publishing_flow(self, mock_all_services):
        ...
        with patch('orchestrator.load_prompts_from_file', return_value={}):
            ...
            with patch('agents.research_agent.requests.post') as mock_post:
                ...
                mock_all_services['gcs'].upload_file.return_value = "https://storage.example.com/img.jpg"
