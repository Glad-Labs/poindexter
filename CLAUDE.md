...
### Key Numbers (repo-derived stats auto-synced daily by CI; DB-derived counts last refreshed 2026-08-23)
...
- 188 live posts on gladlabs.io (362 posts total; 2,054 pipeline_tasks across all generation runs)
...
- 73,534 embeddings across posts / issues / audit / memory / brain / claude_sessions (retention prunes claude_sessions/brain vectors, so this drifts)
