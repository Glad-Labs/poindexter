...
from poindexter.modules.content.stages.quality_evaluation import QualityEvaluationStage
...
class TestExecute:
    async def test_populates_all_expected_keys(self):
        ...
        with patch(
            "poindexter.modules.content.quality_service.UnifiedQualityService",
